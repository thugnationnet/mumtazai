        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-neural-600 max-w-2xl">
              Enhance learning outcomes with AI-powered personalized education, 
            ...
            {[
              {
                ...
                description: 'Adaptive learning experiences tailored to each student'
              },
              {
                title: 'Intelligent Tutoring',
                description: 'AI tutors providing real-time feedback and guidance'
              },
              {
                title: 'Student Performance Analytics',
                description: 'Deep insights into student progress and learning patterns'
              },
              {
                title: 'Administrative Automation',
                description: 'Streamlined grading, scheduling, and administrative tasks'
              }
            ].map((feature, i) => (
              <motion.div
                key={i}
