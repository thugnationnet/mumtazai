        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-neural-600 max-w-2xl">
              Boost sales and customer satisfaction with AI-powered personalization, 
            ...
            {[
              {
                ...
                description: 'AI-powered personalized product suggestions for each customer'
              },
              {
                title: 'Customer Service Automation',
                description: '24/7 AI chatbots handling customer inquiries and support'
              },
              {
                title: 'Inventory Optimization',
                description: 'Predictive analytics for smart inventory management'
              },
              {
                title: 'Dynamic Pricing',
                description: 'AI-driven pricing strategies based on demand and market trends'
              }
            ].map((feature, i) => (
              <motion.div
                key={i}
