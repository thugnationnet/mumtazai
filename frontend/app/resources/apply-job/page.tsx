  ...
  if (submitted) {
    return (
      <div className="min-h-screen flex items-center justify-center py-16 px-4">
        <div className="bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg p-12 text-center max-w-md">
          <div className="mb-6 flex justify-center">
            <CheckCircle className="w-16 h-16 text-green-600" />
          </div>
          <h2 className="text-3xl font-bold text-slate-700 mb-4">Application Submitted!</h2>
          ...
          <Link
            ...
            className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-bold rounded-lg hover:shadow-lg transition-all shadow-lg shadow-purple-500/25"
          >
            Back to Careers
          </Link>
        </div>
    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-14 md:py-20 overflow-hidden rounded-b-[2rem] themed-section-bg">
        ...
        <div className="container-custom text-center relative z-10">
          <h1 className="text-4xl md:text-5xl font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent mb-4">Apply for {position}</h1>
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">Complete the form below to submit your application</p>
        </div>
      </section>
      ...
      <div className="max-w-3xl mx-auto px-4">
        {/* Back Link */}
        <div className="mb-8">
          <Link href="/resources/careers" className="text-purple-700 hover:text-purple-800 font-semibold inline-flex items-center gap-2">
        ...
        {/* Form */}
        <form onSubmit={handleSubmit} className="bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg p-8 mb-8">
          {/* Error Message */}
          {error && (
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              <h2 className="text-2xl font-bold text-slate-700 mb-6">Personal Information</h2>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-white/60 rounded-lg focus:outline-none focus:border-purple-600 transition-colors"
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              <h2 className="text-2xl font-bold text-slate-700 mb-6">Professional Experience</h2>
              
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-2">Current Position *</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-4">Areas of Expertise *</label>
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg font-semibold transition-all ${
                        formData.expertise.includes(skill)
                          ...
                          : 'bg-white/40 text-slate-600 hover:bg-slate-200'
                      }`}
                    >
                      {skill}
                    </button>
          ...
          {currentStep === 3 && (
            <div className="space-y-6">
              <h2 className="text-2xl font-bold text-slate-700 mb-6">Work History</h2>
              
              {formData.workHistory.map((history, index) => (
                <div key={index} className="border-2 border-white/60 rounded-lg p-6 bg-white/30 backdrop-blur-sm">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-semibold text-slate-700">Position {index + 1}</h3>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2 border-2 border-white/60 rounded-lg focus:outline-none focus:border-purple-600 transition-colors"
              ...
              <button
                ...
                className="px-4 py-2 border-2 border-purple-600 text-purple-700 font-semibold rounded-lg hover:bg-purple-50 transition-all"
              >
          ...
          {currentStep === 4 && (
            <div className="space-y-6">
              <h2 className="text-2xl font-bold text-slate-700 mb-6">Documents & Portfolio</h2>
              
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-2">Resume/CV *</label>
                <label className="flex items-center justify-center w-full px-6 py-4 border-2 border-dashed border-white/60 rounded-lg cursor-pointer hover:border-purple-600 hover:bg-purple-50 transition-all">
          ...
          {currentStep === 5 && (
            <div className="space-y-6">
              <h2 className="text-2xl font-bold text-slate-700 mb-6">Additional Information</h2>
              
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-2">Tell us about your experience</label>
                <textarea
                  name="additionalInfo"
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-2">What are your salary expectations?</label>
                <textarea
                  name="expectations"
              ...
              <div className="bg-white/30 backdrop-blur-sm p-4 rounded-lg border-l-4 border-purple-600">
          ...
          {currentStep === totalSteps && (
            <CloudflareTurnstile onVerify={onVerify} onExpire={onExpire} className="flex justify-center mt-4" />
          )}

          {/* Navigation Buttons */}
          <div className="flex items-center justify-between gap-4 mt-8 pt-8 border-t border-white/60">
            <button
              type="button"
              onClick={handlePrev}
              disabled={currentStep === 1}
              className="flex items-center gap-2 px-6 py-3 border-2 border-white/60 text-slate-700 font-bold rounded-lg hover:border-purple-600 hover:text-purple-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <ChevronLeft className="w-4 h-4" />
              Previous
            </button>
            ...
            {currentStep < totalSteps ? (
              <button
                type="button"
                onClick={handleNext}
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-bold rounded-lg hover:shadow-lg transition-all shadow-lg shadow-purple-500/25"
              >
                Next
