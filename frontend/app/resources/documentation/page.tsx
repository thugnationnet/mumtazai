  ...
  const sections = {
    'getting-started': {
      ...
      content: (
        <div className="space-y-6">
          <div>
            <h3 className="text-2xl font-bold text-slate-800 mb-3">Welcome to Mumtaz AI</h3>
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">Getting Your First Agent Running</h4>
            <ol className="space-y-3 list-decimal list-inside text-slate-500">
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">Key Concepts</h4>
            <ul className="space-y-3 text-slate-500">
              <li className="flex items-start gap-3">
                ...
                <div><strong className="text-slate-800">Agents:</strong> 18 pre-built AI personalities with specialized knowledge</div>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-6 h-6 bg-indigo-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-indigo-600 text-sm">🎨</span>
                </span>
                <div><strong className="text-slate-800">Studio:</strong> Enhanced chat interface with advanced features</div>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-6 h-6 bg-purple-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-purple-600 text-sm">🖼️</span>
                </span>
                <div><strong className="text-slate-800">Canvas:</strong> AI-powered code and content generation workspace</div>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-green-600 text-sm">🔑</span>
                </span>
                <div><strong className="text-slate-800">API Keys:</strong> Credentials to authenticate your API requests</div>
              </li>
            </ul>
          </div>
    ...
    'api-reference': {
      ...
      content: (
        <div className="space-y-6">
          <div>
            <h3 className="text-2xl font-bold text-slate-800 mb-3">API Reference</h3>
            <p className="text-slate-500 leading-relaxed">
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">Base URL</h4>
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">Core Endpoints</h4>
            <div className="space-y-3">
              <div className="bg-transparent p-4 rounded-xl border border-white/80">
                <p className="font-mono"><span className="text-blue-600 font-bold">GET</span> <span className="text-slate-600">/agents</span></p>
                <p className="text-slate-400 text-sm mt-1">List all available agents</p>
              </div>
              <div className="bg-transparent p-4 rounded-xl border border-white/80">
                <p className="font-mono"><span className="text-green-600 font-bold">POST</span> <span className="text-slate-600">/conversations</span></p>
                <p className="text-slate-400 text-sm mt-1">Create a new conversation with an agent</p>
              </div>
              <div className="bg-transparent p-4 rounded-xl border border-white/80">
                <p className="font-mono"><span className="text-blue-600 font-bold">GET</span> <span className="text-slate-600">/conversations/:id</span></p>
                <p className="text-slate-400 text-sm mt-1">Retrieve conversation history</p>
              </div>
              <div className="bg-transparent p-4 rounded-xl border border-white/80">
                <p className="font-mono"><span className="text-green-600 font-bold">POST</span> <span className="text-slate-600">/conversations/:id/messages</span></p>
                <p className="text-slate-400 text-sm mt-1">Send a message to an agent</p>
              </div>
              <div className="bg-transparent p-4 rounded-xl border border-white/80">
                <p className="font-mono"><span className="text-green-600 font-bold">POST</span> <span className="text-slate-600">/canvas/generate</span></p>
                <p className="text-slate-400 text-sm mt-1">Generate code or content via Canvas</p>
              </div>
            </div>
          </div>

          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">Rate Limits</h4>
            <p className="text-slate-500">API requests are limited to 1000 requests per hour per API key. Premium plans have higher limits.</p>
          </div>
        </div>
      )
    },
    'authentication': {
      ...
      content: (
        <div className="space-y-6">
          <div>
            <h3 className="text-2xl font-bold text-slate-800 mb-3">Authentication</h3>
            <p className="text-slate-500 leading-relaxed">
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">Getting Your API Key</h4>
            <ol className="space-y-3 list-decimal list-inside text-slate-500">
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">Using Your API Key</h4>
            <p className="text-slate-500 mb-3">Include your API key in the Authorization header:</p>
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">Example Request</h4>
            <div className="bg-gray-900 p-4 rounded-xl font-mono text-sm text-green-400 overflow-x-auto">
  ...
  -H "Authorization: Bearer YOUR_API_KEY"`}</pre>
    ...
    'integration-guide': {
      ...
      content: (
        <div className="space-y-6">
          <div>
            <h3 className="text-2xl font-bold text-slate-800 mb-3">Integration Guide</h3>
            <p className="text-slate-500 leading-relaxed">
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">Web Integration</h4>
            <p className="text-slate-500 mb-3">Add a chat widget to your website:</p>
...
<script>
  OnelastAI.init({
    ...
    agent: 'einstein' // or any agent id
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">Slack Integration</h4>
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">Discord Integration</h4>
            <p className="text-slate-500">Similar to Slack, you can integrate Mumtaz AI with Discord to make your agents available as bots in your servers.</p>
          </div>
    ...
    'webhook-troubleshooting': {
      ...
      content: (
        <div className="space-y-6">
          <div>
            <h3 className="text-2xl font-bold text-slate-800 mb-3">Webhook Troubleshooting</h3>
            <p className="text-slate-500 leading-relaxed">
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">Setting Up Webhooks</h4>
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">Common Issues</h4>
            <div className="space-y-4">
              <div className="bg-amber-50 p-4 rounded-xl border border-amber-200">
                <p className="font-bold text-amber-700">Webhook not triggering?</p>
                <p className="text-slate-500 text-sm mt-1">Check that your URL is publicly accessible and returns a 200 status code.</p>
              </div>
              <div className="bg-amber-50 p-4 rounded-xl border border-amber-200">
                <p className="font-bold text-amber-700">Timeouts occurring?</p>
                <p className="text-slate-500 text-sm mt-1">Ensure your webhook endpoint processes requests within 30 seconds.</p>
              </div>
              <div className="bg-amber-50 p-4 rounded-xl border border-amber-200">
                <p className="font-bold text-amber-700">Missing payload data?</p>
                <p className="text-slate-500 text-sm mt-1">Verify you&apos;re subscribing to the correct event types in your dashboard.</p>
              </div>
            </div>
          </div>

          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">Webhook Events</h4>
            <ul className="space-y-2 text-slate-500">
              ...
              <li className="flex items-center gap-2"><span className="text-slate-400">●</span> <strong>conversation.ended:</strong> When a conversation ends</li>
            </ul>
          </div>
    ...
    'canvas-builder': {
      ...
      content: (
        <div className="space-y-6">
          <div>
            <h3 className="text-2xl font-bold text-slate-800 mb-3">Canvas Builder</h3>
            <p className="text-slate-500 leading-relaxed">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-fuchsia-600 p-6 rounded-xl text-white">
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">Key Features</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {[
                ...
                <div key={idx} className="bg-transparent p-4 rounded-xl border border-white/80">
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">How It Works</h4>
            <ol className="space-y-3 list-decimal list-inside text-slate-500">
              <li><strong className="text-slate-800">Describe</strong> — Type what you want to build in the chat prompt</li>
              <li><strong className="text-slate-800">Generate</strong> — Canvas AI creates fully functional code in seconds</li>
              <li><strong className="text-slate-800">Preview</strong> — See the live result in desktop, tablet or mobile view</li>
              <li><strong className="text-slate-800">Iterate</strong> — Request changes, add features, or refine the design</li>
              <li><strong className="text-slate-800">Deploy</strong> — Publish to a live URL or download the source code</li>
            </ol>
          </div>

          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">What You Can Build</h4>
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">API Endpoint</h4>
            <div className="bg-gray-900 p-4 rounded-xl font-mono text-sm text-green-400 overflow-x-auto">
  ...
  "framework": "react"
    ...
    'canvas-studio': {
      ...
      content: (
        <div className="space-y-6">
          <div>
            <h3 className="text-2xl font-bold text-slate-800 mb-3">Canvas Studio IDE</h3>
            <p className="text-slate-500 leading-relaxed">
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">IDE Features</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {[
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">17 Starter Templates</h4>
            <div className="space-y-4">
              <div>
                <p className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-2">HTML & Web</p>
                <div className="flex flex-wrap gap-2">
              ...
              <div>
                <p className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-2">React & Frontend</p>
                <div className="flex flex-wrap gap-2">
              ...
              <div>
                <p className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-2">Backend & API</p>
                <div className="flex flex-wrap gap-2">
              ...
              <div>
                <p className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-2">Advanced</p>
                <div className="flex flex-wrap gap-2">
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">Canvas Builder vs Canvas Studio</h4>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/80">
                    <th className="text-left py-3 px-4 text-slate-800">Feature</th>
                ...
                <tbody className="text-slate-500">
                  <tr className="border-b border-white/80"><td className="py-2 px-4">Single-prompt generation</td><td className="text-center">✅</td><td className="text-center">✅</td></tr>
                  <tr className="border-b border-white/80"><td className="py-2 px-4">Multi-file projects</td><td className="text-center">—</td><td className="text-center">✅</td></tr>
                  <tr className="border-b border-white/80"><td className="py-2 px-4">File tree & editor</td><td className="text-center">—</td><td className="text-center">✅</td></tr>
                  <tr className="border-b border-white/80"><td className="py-2 px-4">Sandbox code runner</td><td className="text-center">—</td><td className="text-center">✅</td></tr>
                  <tr className="border-b border-white/80"><td className="py-2 px-4">17 starter templates</td><td className="text-center">—</td><td className="text-center">✅</td></tr>
                  <tr className="border-b border-white/80"><td className="py-2 px-4">Live preview</td><td className="text-center">✅</td><td className="text-center">✅ (6 modes)</td></tr>
                  <tr className="border-b border-white/80"><td className="py-2 px-4">One-click deploy</td><td className="text-center">✅</td><td className="text-center">✅</td></tr>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <Link href="https://build.mumtaz.ai" className="inline-flex items-center gap-2 px-6 py-3 bg-white border border-white/80 text-slate-600 rounded-xl font-semibold hover:bg-transparent transition">
              Open Canvas Builder
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
              </svg>
  ...
  const agentContent = (agentId: string) => {
    ...
    if (!agent) {
      return {
        ...
        icon: '❓',
        content: <p className="text-slate-500">This agent could not be found.</p>
      }
    }
    return {
      title: agent.name,
      ...
      content: (
        <div className="space-y-6">
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">Capabilities</h4>
            <ul className="space-y-2 text-slate-500">
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">API Integration</h4>
            <div className="bg-gray-900 p-4 rounded-xl font-mono text-sm text-blue-400 overflow-x-auto">
              <pre>{`POST /conversations
{
  ...
  "message": "Your message here"
          ...
          <div>
            <h4 className="text-xl font-bold text-slate-800 mb-3">Use Cases</h4>
            <ul className="space-y-2 text-slate-500">
              <li className="flex items-center gap-2">
          ...
          <Link href={getAgentChatUrl(agentId)} className="inline-flex items-center gap-2 mt-4 px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-xl font-semibold transition shadow-lg shadow-purple-500/25">
            Try {agent.name} Now
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
            </svg>
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative py-14 md:py-20 overflow-hidden rounded-b-[2rem] themed-section-bg">
        ...
        <div className="container-custom text-center relative z-10">
          <div className="max-w-3xl mx-auto bg-white/30 backdrop-blur-2xl border border-white/50 rounded-3xl p-8 md:p-12 shadow-[0_8px_40px_rgba(139,92,246,0.12),inset_0_1px_0_rgba(255,255,255,0.6)]">
            <h1 className="text-4xl md:text-5xl font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent mb-4">Documentation & Agents</h1>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">Learn everything about Mumtaz AI and explore our 18 specialized AI agents</p>
          </div>
        </div>
      </section>
      ...
      <div className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:min-h-[600px]">
          ...
          <div className="w-full lg:w-72 bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg p-5 lg:overflow-y-auto lg:flex-shrink-0 lg:max-h-[calc(100vh-200px)] lg:sticky lg:top-8">
          ...
          <div 
            ref={contentRef}
            className="flex-1 bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg p-6 lg:p-8 lg:overflow-y-auto scroll-mt-4"
          >
            <div className="flex items-center gap-4 mb-6 pb-5 border-b border-white/60">
              <span className="text-4xl lg:text-5xl">{currentContent.icon}</span>
              <h2 className="text-2xl lg:text-3xl font-bold text-slate-800">{currentContent.title}</h2>
            </div>
      ...
      {/* CTA Section */}
      <section className="relative overflow-hidden rounded-2xl mx-4 md:mx-8 my-12 p-12 themed-section-bg">
        <div className="absolute top-[-30%] left-[-5%] w-[40%] h-[70%] rounded-full bg-white/20 blur-3xl" />
        <div className="absolute bottom-[-20%] right-[-5%] w-[35%] h-[60%] rounded-full bg-purple-200/20 blur-3xl" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="https://mumtaz.ai/agents" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-xl font-semibold transition shadow-lg shadow-purple-500/25">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
              Browse All Agents
            </Link>
            <Link href="/support" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white/40 hover:bg-slate-200 text-slate-600 rounded-xl font-semibold transition">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
