  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative py-14 md:py-20 overflow-hidden rounded-b-[2rem] themed-section-bg">
        <div className="absolute top-[-40%] left-[-10%] w-[50%] h-[80%] rounded-full bg-white/20 blur-3xl" />
        <div className="absolute bottom-[-30%] right-[-5%] w-[40%] h-[70%] rounded-full bg-purple-200/20 blur-3xl" />
        <div className="absolute top-[20%] right-[15%] w-[30%] h-[50%] rounded-full bg-indigo-200/15 blur-3xl" />
        <div className="absolute bottom-[10%] left-[20%] w-[25%] h-[40%] rounded-full bg-violet-200/15 blur-3xl" />
        <div className="absolute top-[50%] left-[50%] w-[35%] h-[45%] rounded-full bg-white/10 blur-3xl" />
        ...
        <div className="container-custom text-center relative z-10">
          <h1 className="text-4xl md:text-5xl font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent mb-4">Latest News</h1>
      ...
      <section className="py-12 border-b border-white/60">
        <div className="container-custom text-center max-w-3xl">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-4">Discover Our AI Agents</h2>
          ...
          <div className="grid grid-cols-3 gap-4 max-w-2xl mx-auto text-center">
            <div className="bg-white/40 backdrop-blur-sm rounded-xl p-4 border border-white/50">
              <p className="text-3xl font-bold text-purple-700">{agentSlugs.length}</p>
                ...
                <button
                  ...
                  className={`px-5 py-2.5 rounded-xl font-semibold transition-all flex items-center gap-2 ${
                    selectedCategory === cat.id
                      ...
                      : 'bg-white/40 text-slate-600 hover:bg-slate-200 border border-white/60'
                  }`}
                >
                  {cat.label}
                </button>
        ...
        <section className="py-12">
          <div className="container-custom">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-slate-800">Featured News</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {featuredArticles.map((article) => (
                <div key={article.id} className="group bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg hover:-translate-y-1 overflow-hidden transition-all">
                  {/* Image Area */}
                  <div className="h-40 bg-gradient-to-br from-purple-100 via-indigo-100 to-violet-100 flex items-center justify-center text-5xl group-hover:scale-110 transition-transform">
                    {article.image}
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="text-lg font-bold text-slate-800 mb-2 group-hover:text-purple-700 transition line-clamp-2">
                      {article.title}
                    </h3>
                    ...
                    <button
                      className="flex items-center text-purple-700 font-medium group-hover:translate-x-1 transition-transform"
          ...
          {regularArticles.length > 0 ? (
            <div className="space-y-4">
              {regularArticles.map((article) => (
                <div key={article.id} className="group bg-white/40 backdrop-blur-lg border border-white/60 hover:border-purple-300 rounded-2xl p-6 transition-all hover:shadow-lg">
                  <div className="flex gap-6 items-start">
                    {/* Icon */}
                    <div className="text-4xl flex-shrink-0 bg-gradient-to-br from-purple-100 to-indigo-100 w-16 h-16 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                      {article.image}
                    </div>
            ...
            <div className="text-center py-12">
              <p className="text-slate-400 text-lg">No news articles in this category yet.</p>
            </div>
          )}
        </div>
      </section>
      ...
      {showArticleModal && selectedArticle && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          {/* Backdrop */}
          <div className="absolute inset-0 bg-slate-400" onClick={() => setShowArticleModal(false)} />

          {/* Modal */}
          <div className="relative bg-white border border-white/80 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[85vh] overflow-hidden">
            {/* Header */}
            <div className="sticky top-0 z-10 flex items-center justify-between px-6 py-4 border-b border-white/80 bg-white/95 backdrop-blur">
              <div className="flex items-center gap-3">
                <div className="text-3xl bg-gradient-to-br from-purple-100 to-indigo-100 w-12 h-12 rounded-xl flex items-center justify-center">{selectedArticle.image}</div>
                <div>
                  ...
                  <p className="text-slate-400 text-sm flex items-center gap-2">
                    ...
                    <span className="text-xs bg-purple-50 text-purple-700 px-2 py-1 rounded-full ml-2">{selectedArticle.readTime}</span>
                  </p>
                </div>
              </div>
              <button aria-label="Close" onClick={() => setShowArticleModal(false)} className="px-3 py-2 rounded-xl bg-white/40 hover:bg-slate-200 border border-white/80 text-sm text-slate-600">
                Close
              </button>
            </div>
            ...
            <div className="px-6 py-5 space-y-4 overflow-y-auto max-h-[calc(85vh-64px)]">
              <p className="whitespace-pre-line text-slate-600 leading-relaxed">{selectedArticle.content || selectedArticle.description}</p>

              {/* Bottom actions including Close button */}
              <div className="pt-4 border-t border-white/80 flex justify-end">
                <button onClick={() => setShowArticleModal(false)} className="px-4 py-2 bg-white/40 hover:bg-slate-200 border border-white/80 rounded-xl text-sm text-slate-600">
                  Close
                </button>
              </div>
            </div>
      ...
      <section className="py-12 border-t border-white/60">
        <div className="container-custom">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-slate-800">Available Agents</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {availableAgents.map((agent) => (
              <div key={agent.id} className="group bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg hover:-translate-y-1 p-6 transition-all">
                <div className="text-5xl mb-4 bg-gradient-to-br from-purple-100 to-indigo-100 w-16 h-16 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">{agent.emoji}</div>
                <h3 className="text-xl font-bold text-slate-800 mb-2 group-hover:text-purple-700 transition">{agent.name}</h3>
                <p className="text-slate-500 text-sm mb-6">{agent.description}</p>
                <div className="flex gap-2">
                  <Link href={agent.path} className="flex-1 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white px-4 py-2 rounded-xl font-semibold text-center transition flex items-center justify-center gap-2 text-sm shadow-lg shadow-purple-500/25">
                  ...
                  }} className="bg-white/40 hover:bg-slate-200 border border-white/80 px-4 py-2 rounded-xl transition flex items-center justify-center text-slate-600">
      ...
      <section className="py-12 border-t border-white/60">
        <div className="container-custom">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-slate-800">Coming Soon Agents</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {comingSoonAgents.map((agent) => (
              <div key={agent.id} className="group bg-white/30 backdrop-blur-lg border border-white/60 hover:border-purple-300 rounded-2xl p-6 transition-all hover:shadow-lg opacity-80 hover:opacity-100">
                ...
                <h3 className="text-xl font-bold text-slate-800 mb-2 group-hover:text-purple-600 transition">{agent.name}</h3>
                <p className="text-slate-500 text-sm mb-6">{agent.description}</p>
                <div className="flex gap-2">
      ...
      {showAgentDetails && selectedAgent && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          {/* Backdrop */}
          <div className="absolute inset-0 bg-slate-400" onClick={() => setShowAgentDetails(false)} />
          ...
          <div className="relative bg-white border border-white/80 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[85vh] overflow-hidden">
            ...
            <div className="sticky top-0 z-10 flex items-center justify-between px-6 py-4 border-b border-white/80 bg-white/95 backdrop-blur">
              <div className="flex items-center gap-3">
                <div className="text-4xl bg-gradient-to-br from-purple-100 to-indigo-100 w-14 h-14 rounded-xl flex items-center justify-center">{selectedAgent.emoji}</div>
                <div>
              ...
              <button aria-label="Close" onClick={() => setShowAgentDetails(false)} className="px-3 py-2 rounded-xl bg-white/40 hover:bg-slate-200 border border-white/80 text-sm text-slate-600">
                Close
              </button>
            </div>
            ...
            <div className="px-6 py-5 space-y-6 overflow-y-auto max-h-[calc(85vh-64px)]">
              ...
              {selectedAgent.specialties?.length > 0 && (
                <div>
                  <h3 className="text-lg font-semibold text-slate-800 mb-2">Specialties</h3>
                  <div className="flex flex-wrap gap-2">
                    {selectedAgent.specialties.map((s: string, idx: number) => (
                      <span key={idx} className="text-xs bg-purple-50 border border-purple-200 px-3 py-1.5 rounded-full text-purple-700">
                        {s}
                      </span>
                    ))}
                  </div>
              ...
              {selectedAgent.details?.length > 0 && (
                <div>
                  <h3 className="text-lg font-semibold text-slate-800 mb-3">How this agent works</h3>
                  <div className="space-y-4">
                    {selectedAgent.details.map((section: any, idx: number) => (
                      <div key={idx} className="bg-transparent border border-white/80 rounded-xl p-4">
                ...
                {selectedAgent.path ? (
                  <>
                    ...
                    <div className="mt-3 flex gap-3">
                      <Link href="/overview/pricing" className="px-4 py-2 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-xl text-sm font-semibold shadow-lg shadow-purple-500/25">View Plans</Link>
                      <Link href={selectedAgent.path} className="px-4 py-2 bg-white/40 hover:bg-slate-200 border border-white/80 rounded-xl text-sm text-slate-600">Launch Agent</Link>
                    </div>
                  ...
                  <div className="bg-purple-50 border border-purple-200 rounded-xl p-4">
                    ...
                    <div className="flex gap-3">
                      ...
                      <Link href="https://mumtaz.ai/agents" className="px-4 py-2 bg-white/40 hover:bg-slate-200 border border-white/80 rounded-xl text-sm text-slate-600">Browse Available Agents</Link>
                    </div>
      ...
      {/* Newsletter Section */}
      <section className="relative overflow-hidden rounded-2xl mx-4 md:mx-8 my-12 p-8 themed-section-bg">
        ...
        <div className="container-custom max-w-2xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center justify-center w-14 h-14 bg-white/40 backdrop-blur-sm rounded-2xl border border-white/60 mb-4">
            <span className="text-2xl">📧</span>
          </div>
          <h2 className="text-3xl font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent mb-4">Stay Updated</h2>
          ...
          <div className="flex gap-3">
            <input
              ...
              className="flex-1 px-4 py-3 bg-white/60 border border-white/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-400 text-slate-800 placeholder-gray-500"
            />
            <button className="px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-xl font-semibold transition shadow-lg shadow-purple-500/25">
              Subscribe
            </button>
          </div>
          <p className="text-slate-500 text-sm mt-3">No spam, just quality news and updates.</p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container-custom max-w-4xl mx-auto">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-slate-800">Explore More</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/resources/blog" className="group bg-white/40 backdrop-blur-lg border border-white/60 hover:border-purple-300 p-6 rounded-2xl transition shadow-lg hover:shadow-xl">
              <div className="text-3xl mb-3 bg-gradient-to-br from-purple-100 to-indigo-100 w-12 h-12 rounded-xl flex items-center justify-center">📖</div>
              <h3 className="text-lg font-bold text-slate-800 mb-2 group-hover:text-purple-700 transition">Read Blog Articles</h3>
              <p className="text-slate-500 text-sm mb-4">Explore in-depth articles on AI, agents, and technology trends.</p>
              <div className="flex items-center text-purple-700 font-medium group-hover:translate-x-1 transition-transform">
                Read Blog
                <ArrowRight className="w-4 h-4 ml-2" />
              </div>
            </Link>

            <Link href="/community" className="group bg-white/40 backdrop-blur-lg border border-white/60 hover:border-purple-300 p-6 rounded-2xl transition shadow-lg hover:shadow-xl">
              ...
              <h3 className="text-lg font-bold text-slate-800 mb-2 group-hover:text-purple-700 transition">Join Community</h3>
              <p className="text-slate-500 text-sm mb-4">Connect with other users and share insights with the community.</p>
              <div className="flex items-center text-purple-700 font-medium group-hover:translate-x-1 transition-transform">
                Go to Community
                <ArrowRight className="w-4 h-4 ml-2" />
              </div>
            ...
            <Link href="/resources/documentation" className="group bg-white/40 backdrop-blur-lg border border-white/60 hover:border-purple-300 p-6 rounded-2xl transition shadow-lg hover:shadow-xl">
              ...
              <h3 className="text-lg font-bold text-slate-800 mb-2 group-hover:text-purple-700 transition">View Documentation</h3>
              <p className="text-slate-500 text-sm mb-4">Check out our comprehensive documentation and guides.</p>
              <div className="flex items-center text-purple-700 font-medium group-hover:translate-x-1 transition-transform">
                Read Docs
                <ArrowRight className="w-4 h-4 ml-2" />
              </div>
