      ...
      <section className="relative py-14 md:py-20 overflow-hidden rounded-b-[2rem] themed-section-bg">
          ...
          <div className="text-center max-w-4xl mx-auto">
            <div className="bg-white/30 backdrop-blur-2xl border border-white/50 rounded-3xl p-8 md:p-12 shadow-[0_8px_40px_rgba(139,92,246,0.12),inset_0_1px_0_rgba(255,255,255,0.6)]">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/resources/tutorials" className="px-7 py-3 bg-white/50 border border-white/60 text-slate-700 font-bold rounded-xl hover:bg-white/70 transition-all duration-300 backdrop-blur-sm">
                  View Tutorials
                </Link>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg p-8 text-center">
            ...
            <h3 className="text-xl font-bold text-slate-700 mb-3">Workflow Designer</h3>
            <p className="text-slate-500">Visual drag-and-drop interface for creating complex automation workflows</p>
          </div>
          <div className="bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg p-8 text-center">
            <div className="text-4xl mb-4">⚡</div>
            <h3 className="text-xl font-bold text-slate-700 mb-3">Smart Triggers</h3>
            <p className="text-slate-500">AI-powered triggers that adapt to changing business conditions</p>
          </div>
          <div className="bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg p-8 text-center">
            <div className="text-4xl mb-4">📈</div>
            <h3 className="text-xl font-bold text-slate-700 mb-3">Process Analytics</h3>
            <p className="text-slate-500">Real-time insights into process performance and optimization opportunities</p>
          </div>
        </div>
