            ...
            {apps.map((app, i) => {
              ...
              return (
                <motion.div
                  ...
                  className={`relative bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg ${app.borderColor} hover:shadow-lg transition-all duration-300 overflow-hidden`}
                >
                  <div className="p-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            {[
              ...
              return (
                <div
                  key={i}
                  className="text-center p-6 bg-transparent rounded-xl border border-white/80"
                >
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {creditPacks.map((pack, i) => (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: i * 0.1 }}
                className={`relative bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg ${
                  pack.popular
                    ? 'border-emerald-500'
                    : ''
                } overflow-hidden`}
              >
                ...
                <div className={`p-6 ${pack.popular ? 'pt-9' : ''}`}>
                  ...
                  <div className="space-y-2.5 mb-6">
                    ...
                    <div className="flex items-center gap-2.5 text-sm">
                      <CheckCircle2 className="w-4 h-4 text-emerald-500 flex-shrink-0" />
                      <span className="text-slate-600">No auto-renewal</span>
                    </div>
                  </div>
                  <a
                    href="https://maula.mumtaz.ai"
          ...
          <div className="max-w-5xl mx-auto mt-8">
            <div className="bg-white/40 backdrop-blur-lg rounded-2xl p-5 text-center border border-white/60 shadow-lg">
          ...
          <div className="bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead className="bg-transparent border-b border-white/60">
                  <tr>
            ...
            <div className="p-4 bg-transparent border-t border-white/80">
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead className="bg-transparent border-b-2 border-white/60">
                  <tr>
          ...
          <div className="flex flex-wrap justify-center gap-2.5">
            {toolCategories.map((cat, i) => (
              <motion.span
                ...
                className="inline-flex items-center px-4 py-2 rounded-full bg-transparent border border-white/80 text-sm font-semibold text-[#1e293b] hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-800 transition"
              >
                {cat}
              </motion.span>
            ))}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              return (
                <div
                  key={i}
                  className="flex items-start gap-4 p-5 bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg"
                >
