    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h1 className="text-5xl md:text-6xl font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent">Tools & Utilities</h1>
            </div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          ...
          >
            <h2 className="text-2xl font-bold text-slate-700 mb-6 text-center">Where to Find Tools</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-transparent rounded-xl p-6">
                ...
                <h3 className="font-bold text-slate-700 mb-2">Agent Chat Tools (188)</h3>
                <p className="text-sm text-slate-500">Available in Universal Chat when talking to any AI agent. Tools are invoked automatically based on your request.</p>
              </div>
              <div className="bg-transparent rounded-xl p-6">
                ...
                <h3 className="font-bold text-slate-700 mb-2">Canvas Studio Tools (201)</h3>
                <p className="text-sm text-slate-500">Available in Canvas and Canvas Studio IDE. Use them for app building, code generation, and project management.</p>
              </div>
            </div>
            <p className="text-sm text-slate-400 text-center mt-4">13 tools are shared between both environments</p>
          </motion.div>
        </div>

        {/* Tool Categories */}
        <h2 className="text-3xl font-bold text-slate-700 text-center mb-8">All Tool Categories</h2>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-2">
                    <h3 className="text-lg font-bold text-slate-700">{cat.title}</h3>
                    <span className="px-2 py-0.5 rounded-full text-xs bg-white/40 text-slate-500 font-medium">{cat.count} tools</span>
                  </div>
                  <p className="text-sm text-slate-500 mb-3">{cat.description}</p>
                  <div className="flex flex-wrap gap-1.5">
                    {cat.tools.slice(0, 6).map((tool, tIdx) => (
                      <span key={tIdx} className="px-2 py-1 text-xs bg-transparent text-slate-500 rounded-md border border-white/80">
                        {tool}
                      </span>
                    ))}
                    {cat.tools.length > 6 && (
                      <span className="px-2 py-1 text-xs bg-transparent text-slate-400 rounded-md border border-white/80">
        ...
        {/* How Tools Work */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-slate-700 text-center mb-8">How Tools Work</h2>
            ...
            {[
              ...
              >
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-slate-700 mb-1">{step.title}</h3>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative overflow-hidden rounded-2xl p-8 md:p-12 text-center themed-section-bg">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent mb-4">Try the Tools</h2>
              <p className="text-lg text-slate-600 mb-8">
                Start a chat with any agent or open Canvas Studio to access all 389 tools.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/chat" className="px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-semibold rounded-xl hover:shadow-[0_0_25px_rgba(139,92,246,0.35)] transition-all">
                  Open Chat
                </Link>
                <Link href="https://studio.mumtaz.ai" className="px-6 py-3 bg-white/40 backdrop-blur-sm text-slate-700 border border-white/60 font-semibold rounded-xl hover:bg-white/50 transition">
                  Open Canvas Studio
                </Link>
              </div>
            </div>
