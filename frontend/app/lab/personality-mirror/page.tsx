        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
          ...
          >
            ...
            <div className="flex items-center gap-6 mt-6">
              ...
              <div className="text-sm text-slate-600">{stats.totalAnalyzed.toLocaleString()} analyses completed</div>
            </div>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <textarea
              ...
              className="w-full h-64 bg-white/60 border border-white/60 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-teal-500 transition-colors resize-none mb-6"
            />
