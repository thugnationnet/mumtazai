        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
          ...
          >
            ...
            <div className="flex items-center gap-6 mt-6">
              ...
              <div className="text-sm text-slate-600">{stats.totalDebates.toLocaleString()} debates hosted</div>
              <div className="text-sm text-slate-400">•</div>
              ...
              <button
                onClick={loadDebates}
                className="ml-auto flex items-center gap-2 text-sm text-slate-500 hover:text-purple-700 transition-colors"
              >
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <div className="flex gap-4">
                <input
                  ...
                  className="flex-1 bg-white/60 border border-white/60 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-purple-500 transition-colors"
            ...
            >
              ...
              {isLoading ? (
                ...
                <div className="text-center py-12 bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg">
