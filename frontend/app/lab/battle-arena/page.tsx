        ...
        <div className="container mx-auto px-4 py-12 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <div className="flex items-center gap-4 mb-4">
              <div className="p-3 rounded-2xl bg-white/40 border border-white/60 shadow-lg"><Swords className="w-10 h-10 text-purple-600" /></div>
              <div>
                <h1 className="text-4xl font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent">AI Battle Arena</h1>
                <p className="text-slate-600 mt-1">Pit the world&apos;s best AI models against each other</p>
              </div>
            </div>
            ...
            {userStats && (
              <div className="flex flex-wrap gap-6 mt-4">
                {[
                  ...
                  <div key={i} className="text-center bg-white/40 backdrop-blur-sm rounded-xl px-4 py-2 border border-white/60">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {tab === 'battle' && (
          <>
              ...
              <>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                  {['Player 1', 'Player 2'].map((label, pi) => {
                    ...
                    return (
                      <div key={label} className="bg-white/40 backdrop-blur-lg rounded-2xl p-5 border border-white/60 shadow-lg">
                ...
                <div className="bg-white/40 backdrop-blur-lg rounded-2xl p-5 border border-white/60 shadow-lg mb-6">
                  ...
                  <textarea value={prompt} onChange={e => setPrompt(e.target.value)} placeholder="Enter your challenge..." className="w-full h-28 bg-white/60 border border-white/60 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-purple-500 resize-none" />
                  <button onClick={handleStartBattle} disabled={!prompt || !model1 || !model2 || isLoading}
                    className="w-full mt-3 py-3 bg-white/40 border border-white/60 rounded-xl shadow-lg font-semibold text-slate-700 disabled:opacity-50 flex items-center justify-center gap-2">
            ...
            {roundResults.length > 0 && (
              <div className="mt-8 bg-white/40 backdrop-blur-lg rounded-2xl p-5 border border-white/60 shadow-lg">
        ...
        {tab === 'agents' && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {agents.map((agent) => (
              <motion.div key={agent.id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="bg-white/40 backdrop-blur-lg rounded-2xl p-5 border border-white/60 shadow-lg hover:shadow-xl transition-shadow">
        ...
        {tab === 'history' && (
          <div className="space-y-3">
            {pastBattles.length === 0 ? (
              ...
              <div key={i} className="bg-white/40 backdrop-blur-lg rounded-2xl p-4 border border-white/60 shadow-lg flex items-center gap-4">
        ...
        {tab === 'tournaments' && (
          <div className="space-y-4">
            {tournaments.length === 0 ? (
              ...
              <div key={t.id} className="bg-white/40 backdrop-blur-lg rounded-2xl p-5 border border-white/60 shadow-lg">
                <div className="flex items-start gap-4">
                  <div className="p-3 bg-white/40 border border-white/60 rounded-2xl shadow-lg"><Award className="w-6 h-6 text-purple-600" /></div>
                  <div className="flex-1">
