        ...
        <div className="container mx-auto px-4 py-12 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <div className="flex items-center gap-4 mb-4">
              <div className="p-3 rounded-2xl bg-white/40 border border-white/60 shadow-lg"><Heart className="w-10 h-10 text-purple-600" /></div>
              <div>
                <h1 className="text-4xl font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent">Emotion Visualizer</h1>
                <p className="text-slate-600 mt-1">AI-powered emotion analysis &amp; visualization</p>
              </div>
            </div>
              ...
              {isAnalyzing ? (
                ...
                <AnimatePresence mode="wait">
                  <motion.div key="results" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-5">
                    {/* Sentiment overview */}
                    <div className="neu-info p-4 text-center">
                      {getSentimentIcon()}
            ...
            {!insights ? (
              <div className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border border-white/60 shadow-lg text-center">
                ...
                <button onClick={generateInsights} disabled={isLoadingInsights}
                  className="px-6 py-3 bg-white/40 border border-white/60 rounded-xl shadow-lg font-semibold text-slate-700 disabled:opacity-50 flex items-center gap-2 mx-auto">
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-white/40 backdrop-blur-lg rounded-2xl p-5 border border-white/60 shadow-lg text-center">
        ...
        {tab === 'history' && (
          <div className="space-y-3">
            {history.length === 0 ? (
              ...
              <div key={i} className="bg-white/40 backdrop-blur-lg rounded-2xl p-4 border border-white/60 shadow-lg">
