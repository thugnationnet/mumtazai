    ...
    <div className="min-h-screen">
          ...
          >
            ...
            <div className="flex items-center gap-6 mt-6">
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="text-slate-600">342 users active</span>
              </div>
              <div className="text-sm text-slate-400">•</div>
              <div className="text-sm text-slate-600">12,450 images generated</div>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            {/* Prompt Input */}
            <div className="bg-white/40 backdrop-blur-lg rounded-2xl p-6 border border-white/60 shadow-lg mb-6">
              ...
              <textarea
                ...
                className="w-full h-32 bg-white/60 border border-white/60 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-purple-500 transition-colors resize-none"
              />
