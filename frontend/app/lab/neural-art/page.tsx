    ...
    <div className="min-h-screen">
          ...
          >
            ...
            <div className="flex items-center gap-6 mt-6">
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="text-slate-600">256 users active</span>
              </div>
              <div className="text-sm text-slate-400">•</div>
              <div className="text-sm text-slate-600">9,840 artworks created</div>
            </div>
          </motion.div>
        </div>
      </section>
      <div className="container mx-auto px-4 py-12">
        ...
        <motion.div
          ...
          className="bg-white/40 backdrop-blur-lg rounded-2xl p-6 border border-white/60 shadow-lg mb-8"
        >
