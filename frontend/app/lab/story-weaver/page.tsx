        ...
        <div className="container mx-auto px-4 py-12 relative">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <div className="flex items-center gap-4 mb-4">
              <div className="p-3 rounded-2xl bg-gradient-to-br from-green-500 to-emerald-500 shadow-lg"><BookOpen className="w-10 h-10 text-white" /></div>
              <div>
                <h1 className="text-4xl font-bold text-white">AI Story Weaver</h1>
                <p className="text-blue-100 mt-1">Collaborate with AI to write compelling stories</p>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-1 space-y-4">
              ...
              <div className="bg-white rounded-2xl p-5 border border-gray-200 shadow-sm">
                ...
                <button onClick={handleGenerate} disabled={isGenerating}
                  className="w-full py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg text-sm font-medium disabled:opacity-50 flex items-center justify-center gap-1.5">
            ...
            <div className="lg:col-span-3 space-y-4">
              <div className="bg-white rounded-2xl p-5 border border-gray-200 shadow-sm">
                ...
                <textarea value={story} onChange={e => setStory(e.target.value)} placeholder="Start typing your story or choose a story starter..." className="w-full h-80 bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-emerald-500 resize-none font-serif text-lg leading-relaxed" />
                <div className="flex gap-3 mt-4">
                  <button onClick={handleContinue} disabled={!story.trim() || isGenerating}
                    className="flex-1 py-3 bg-gradient-to-r from-green-600 to-emerald-600 rounded-xl font-semibold text-white shadow-lg shadow-green-500/25 disabled:opacity-50 flex items-center justify-center gap-2">
        ...
        {tab === 'stories' && (
          <div className="space-y-3">
            {userStories.length === 0 ? (
              ...
              <div key={s.id} className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
        ...
        {tab === 'templates' && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {templates.map(t => (
              <div key={t.id} className="bg-white rounded-2xl p-5 border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between mb-2">
        ...
        {tab === 'genres' && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {genres.map(g => (
              <div key={g.id} className="bg-white rounded-2xl p-5 border border-gray-200 shadow-sm">
