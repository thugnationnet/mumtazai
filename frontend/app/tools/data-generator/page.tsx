    ...
    <div className="min-h-screen themed-section-bg">
      ...
      <div className="container-custom py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <button
                      ...
                      className={`p-3 rounded-xl text-left transition-all ${
                        isSelected
                          ...
                          : 'bg-gray-50 text-slate-600 hover:bg-gray-100 border border-white/80'
                      }`}
                    >
                      <Icon
                        className={`w-5 h-5 mb-1 ${isSelected ? 'text-white' : 'text-slate-400'}`}
                      />
            ...
            <div className="bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg p-6">
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${
                      recordCount === num
                        ...
                        : 'bg-gray-100 text-slate-500 hover:bg-gray-200 border border-white/80'
                    }`}
                  >
                    {num}
                  </button>
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-gray-50 border border-white/80 rounded-lg text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-blue-500/25 transition-all"
              >
            ...
            <div className="bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {currentTemplate.fields.map((field) => (
                  <span
                    key={field}
                    className="px-2 py-1 bg-gray-100 border border-white/80 rounded text-xs text-slate-600 font-mono"
                  >
                    {field}
                  </span>
                ))}
          ...
          <div className="lg:col-span-2">
            <div className="bg-slate-100[#1e1e2e] rounded-2xl border border-gray-300 overflow-hidden shadow-xl">
              {/* Terminal Title Bar */}
                ...
                <div className="flex items-center gap-2">
                  {generatedData.length > 0 && (
                    <>
                      <button
                        onClick={handleCopy}
                        className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-700/50 hover:bg-slate-500 rounded-md text-xs text-slate-300 transition-colors border border-slate-500/50"
                      >
                        {copied ? (
              ...
              <div className="h-[500px] overflow-y-auto bg-slate-100[#1e1e2e] custom-scrollbar">
                {generatedData.length === 0 ? (
      ...
      <section className="py-12 border-t border-gray-200">
        <div className="container-custom">
          <h2 className="text-2xl font-bold text-slate-700 text-center mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={idx}
                className="p-6 bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg hover:-translate-y-1 transition-all duration-300"
              >
          ...
          <div className="max-w-4xl mx-auto mt-16">
            <div className="relative py-14 overflow-hidden rounded-[2rem] mx-4 mb-8 p-8 md:p-12 text-center themed-section-bg">
              ...
              <div className="relative z-10">
                <h2 className="text-3xl font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent mb-4">Explore More Tools</h2>
                <p className="text-base md:text-lg text-slate-600 mb-8 leading-relaxed">
                  Check out our full suite of developer and network tools to boost your productivity.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link href="/tools" className="px-7 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-bold rounded-xl hover:shadow-[0_0_25px_rgba(139,92,246,0.35)] transition-all duration-300 hover:scale-105">
                    All Tools
                  </Link>
                  <Link href="https://mumtaz.ai/agents" className="px-7 py-3 bg-white/50 border border-white/60 text-slate-700 font-bold rounded-xl hover:bg-white/70 transition-all duration-300 backdrop-blur-sm">
                    Explore AI Agents
                  </Link>
                </div>
              </div>
