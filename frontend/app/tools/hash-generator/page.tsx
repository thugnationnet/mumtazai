    ...
    <div className="min-h-screen themed-section-bg">
      <header className="relative py-14 md:py-20 overflow-hidden rounded-b-[2rem] themed-section-bg">
        ...
        <div className="container-custom relative z-10 py-6">
          ...
          <div className="mt-3 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent">Hash Generator</h1>
              <p className="text-slate-500">Generate MD5, SHA-1, SHA-256, SHA-512 and optional HMAC (SHA-256)</p>
            </div>
          </div>
          </div>
        </div>
      ...
      <main className="container-custom py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg p-4 lg:col-span-1">
          ...
          <div className="lg:col-span-2 space-y-3">
            {['MD5','SHA-1','SHA-256','SHA-512','HMAC-SHA256'].map(lbl => (
              <div key={lbl} className="bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg p-4 flex items-center justify-between">
                <div>
