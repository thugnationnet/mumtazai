      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="card card-padding mb-8">
            <form onSubmit={handleManualSearch} className="flex gap-3">
              ...
              <button
                ...
                className="px-7 py-3 bg-gradient-to-r from-violet-500 to-purple-500 text-white font-bold rounded-xl hover:shadow-[0_0_25px_rgba(139,92,246,0.35)] transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                {searchLoading ? (
          ...
          {ipData && (
            <>
              {/* IP Address Header */}
              <div className="rounded-lg p-6 mb-8 text-white px-7 py-3 bg-gradient-to-r from-violet-500 to-purple-500 text-white font-bold rounded-xl hover:shadow-[0_0_25px_rgba(139,92,246,0.35)] transition-all duration-300 hover:scale-105 !w-full !justify-between">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="p-2 bg-slate-200 hover:bg-black/30 rounded-lg transition-colors"
              ...
              {ipData.location.coordinates && (
                <div className="mb-8 card overflow-hidden">
                  <div className="p-4 border-b border-gray-200 neu-info">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
