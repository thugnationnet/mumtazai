      ...
      <header className="relative py-14 md:py-20 overflow-hidden rounded-b-[2rem] themed-section-bg">
        ...
        <div className="container-custom relative z-10 py-6">
          ...
          <div className="mt-3 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent">Color Picker</h1>
              <p className="text-slate-500">Pick colors and convert between HEX, RGB, and HSL</p>
            </div>
          </div>
          </div>
        </div>
      ...
      <main className="container-custom py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div className="bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg p-4 flex items-center gap-3">
            ...
            <div className="bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg p-4 flex items-center gap-3 flex-wrap">
