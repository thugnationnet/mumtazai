    ...
    <div className="min-h-screen themed-section-bg">
      <div className="relative py-14 md:py-20 overflow-hidden rounded-b-[2rem] themed-section-bg">
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4 font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent">Notepad <span className="text-slate-500">Online</span></h1>
            <p className="text-xl text-slate-500 max-w-2xl mx-auto">Multi-tab text editor with find/replace, themes, auto-save & Markdown preview</p>
          </div>
          </div>
        </div>
      </div>
      ...
      <main className="container-custom py-8">
        <div className="max-w-5xl mx-auto space-y-4">
          {/* Toolbar */}
          <div className="bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg p-3 flex flex-wrap items-center gap-2">
            <button onClick={saveAll} className="px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors flex items-center gap-1.5 text-sm">
            ...
            <button onClick={() => setShowFind(!showFind)} className={`p-2 rounded-lg ${showFind ? 'bg-blue-100 text-blue-700' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-100'}`} title="Find & Replace"><Search className="w-4 h-4" /></button>
            <button onClick={() => setShowPreview(!showPreview)} className={`p-2 rounded-lg ${showPreview ? 'bg-blue-100 text-blue-700' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-100'}`} title="Markdown Preview"><Eye className="w-4 h-4" /></button>
            <div className="w-px h-6 bg-gray-200" />
          ...
          {/* Find & Replace */}
          {showFind && (
            <div className="bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg shadow p-3 flex flex-wrap items-center gap-2">
          ...
          {/* Status Bar */}
          <div className="bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-lg p-3 flex flex-wrap gap-4 text-xs text-gray-500 items-center">
