      ...
      <header className="relative py-14 md:py-20 overflow-hidden rounded-b-[2rem] themed-section-bg">
        ...
        <div className="container-custom relative z-10 py-6">
          ...
          <div className="mt-3 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent">Timestamp Converter</h1>
              <p className="text-slate-500">Convert between Unix epoch (seconds/ms) and human-readable dates with time zones</p>
            </div>
          </div>
          </div>
        </div>
