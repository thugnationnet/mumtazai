      ...
      <div className="relative py-14 md:py-20 overflow-hidden rounded-b-[2rem] themed-section-bg">
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4 font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent">Punycode <span className="text-slate-500">Converter</span></h1>
            <p className="text-xl text-slate-500 max-w-2xl mx-auto">Convert international domain names to and from Punycode (IDN)</p>
          </div>
          </div>
        </div>
      </div>
            ...
            {tab === 'single' ? (
              <>
                ...
                <div className="flex gap-3">
                  ...
                  <button onClick={handleConvert} className="px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg font-semibold hover:opacity-90 transition-opacity">Convert</button>
                </div>
              </>
            ) : (
              <>
              ...
              <div className="space-y-2">
                {batchResults.map((r, i) => (
                  <div key={i} className="flex items-center gap-3 py-2.5 px-3 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <button onClick={() => copy(r.output, `batch-${i}`)} className="text-gray-400 hover:text-blue-600 transition-colors">
