      ...
      <div className="bg-gradient-to-r from-brand-600 to-accent-600 py-12">
        <div className="container-custom">
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">Word <span className="text-blue-100">Counter</span></h1>
            <p className="text-xl text-blue-100 max-w-2xl mx-auto">Analyze text with word counts, readability scores, keyword density, and more</p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`flex-1 px-3 py-3 text-xs font-medium flex items-center justify-center gap-1.5 transition-colors
                        ${activeTab === tab.id ? 'text-brand-600 border-b-2 border-brand-600 bg-brand-50/50' : 'text-gray-500 hover:text-gray-700'}`}
                    >
                            ...
                            <div key={k.word} className="flex items-center gap-2">
                              ...
                              <div className="flex-1">
                                ...
                                <div className="w-full bg-gray-100 rounded-full h-1.5">
                                  <div className="bg-brand-500 h-1.5 rounded-full" style={{ width: `${Math.min(100, (k.count / stats.keywords[0].count) * 100)}%` }} />
                                </div>
                              </div>
                            </div>
                          ))}
              ...
              <div className="bg-white rounded-2xl border border-gray-200 shadow-lg p-4 space-y-2">
                <button onClick={copy} disabled={!text} className="w-full px-4 py-2.5 bg-brand-600 hover:bg-brand-700 text-white rounded-lg transition-colors flex items-center justify-center gap-2 text-sm font-medium disabled:opacity-50">
