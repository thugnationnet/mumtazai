    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-14 md:py-20 overflow-hidden rounded-b-[2rem] themed-section-bg">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent mb-4">Cookie Policy</h1>
        ...
        <div className="space-y-12">
          ...
          <section className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border border-white/60 shadow-lg">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  This Cookie Policy explains how Mumtaz AI ("we," "our," or
            ...
            <div className="bg-blue-50 rounded-xl p-6 border border-blue-200 mt-6">
              <p className="text-slate-600">
                <strong className="text-slate-800">Legal Framework:</strong> Our
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="bg-transparent rounded-xl p-4 border border-white/80">
                    ...
                    <p className="text-slate-500 text-sm">
                      Set by Mumtaz AI directly. We have full control over
                      these cookies.
                    </p>
                  </div>
                  <div className="bg-transparent rounded-xl p-4 border border-white/80">
                  ...
                  <table className="w-full text-sm">
                    <thead className="bg-green-100">
                      <tr className="border-b border-green-200">
                        ...
                        <th className="text-left p-3 text-slate-800">Purpose</th>
                        <th className="text-left p-3 text-slate-800">Attributes</th>
                        <th className="text-left p-3 text-slate-800">Duration</th>
                      </tr>
                    </thead>
                      ...
                      <table className="w-full text-xs">
                        <thead className="bg-blue-100">
                          <tr className="border-b border-blue-200">
                            <th className="text-left p-2 text-slate-800">Data Collected</th>
                            <th className="text-left p-2 text-slate-800">
                              Purpose
                            </th>
                            <th className="text-left p-2 text-slate-800">
                              Retention
                  ...
                  <div className="bg-white rounded-lg p-4 border border-blue-100">
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full text-xs">
                        <thead className="bg-blue-100">
                          <tr className="border-b border-blue-200">
                            <th className="text-left p-2 text-slate-800">Metric</th>
                            <th className="text-left p-2 text-slate-800">
                              Purpose
                            </th>
                            <th className="text-left p-2 text-slate-800">
          ...
          <section className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border border-white/60 shadow-lg">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-transparent rounded-xl p-6 border border-white/80">
                ...
                <p className="text-slate-500 text-sm mb-2">
                  All AI API calls are made through <strong>Mumtaz AI&apos;s own platform API keys</strong> on your behalf —
          ...
          <section className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border border-white/60 shadow-lg">
              ...
              <table className="w-full text-sm border-collapse border border-white/80 rounded-lg overflow-hidden">
                <thead>
                  <tr className="bg-white/40 text-slate-800">
                    <th className="text-left p-3 border border-white/80 font-semibold">Key</th>
                    <th className="text-left p-3 border border-white/80 font-semibold">Application</th>
                    <th className="text-left p-3 border border-white/80 font-semibold">Data Stored</th>
                    <th className="text-left p-3 border border-white/80 font-semibold">Purpose</th>
                  </tr>
                </thead>
                <tbody className="text-slate-600">
                  <tr>
                    <td className="p-3 border border-white/80 font-mono text-xs">mumtazai_user_id</td>
                    <td className="p-3 border border-white/80">All apps</td>
                    <td className="p-3 border border-white/80">UUID string</td>
                    <td className="p-3 border border-white/80">Link anonymous analytics</td>
                  </tr>
                  <tr className="bg-transparent">
                    <td className="p-3 border border-white/80 font-mono text-xs">canvas_studio_usage</td>
                    <td className="p-3 border border-white/80">Canvas Studio</td>
                    <td className="p-3 border border-white/80">Usage counter</td>
                    <td className="p-3 border border-white/80">Track free-tier usage limit</td>
                  </tr>
                  <tr>
                    <td className="p-3 border border-white/80 font-mono text-xs">canvas_studio_model</td>
                    <td className="p-3 border border-white/80">Canvas Studio</td>
                    <td className="p-3 border border-white/80">Model name string</td>
                    <td className="p-3 border border-white/80">Remember preferred AI model</td>
                  </tr>
                  <tr className="bg-transparent">
                    <td className="p-3 border border-white/80 font-mono text-xs">canvas_studio_provider</td>
                    <td className="p-3 border border-white/80">Canvas Studio</td>
                    <td className="p-3 border border-white/80">Provider name string</td>
                    <td className="p-3 border border-white/80">Remember preferred AI provider</td>
                  </tr>
                  <tr>
                    <td className="p-3 border border-white/80 font-mono text-xs">canvas_dark_mode</td>
                    <td className="p-3 border border-white/80">Canvas Studio</td>
                    <td className="p-3 border border-white/80">Boolean</td>
                    <td className="p-3 border border-white/80">Theme preference</td>
                  </tr>
                  <tr className="bg-transparent">
                    <td className="p-3 border border-white/80 font-mono text-xs">gencraft_v4_history</td>
                    <td className="p-3 border border-white/80">GenCraft Pro</td>
                    <td className="p-3 border border-white/80">JSON array of past prompts</td>
                    <td className="p-3 border border-white/80">Prompt history for quick reuse</td>
                  </tr>
                  <tr>
                    <td className="p-3 border border-white/80 font-mono text-xs">userEmail</td>
                    <td className="p-3 border border-white/80">All apps</td>
                    <td className="p-3 border border-white/80">Email string</td>
                    <td className="p-3 border border-white/80">Pre-fill login forms</td>
                  </tr>
                  <tr className="bg-transparent">
                    <td className="p-3 border border-white/80 font-mono text-xs">auth_token</td>
                    <td className="p-3 border border-white/80">All apps</td>
                    <td className="p-3 border border-white/80">JWT string</td>
                    <td className="p-3 border border-white/80">Client-side auth state</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="bg-amber-50 rounded-xl p-4 border border-amber-200 mt-4">
              <p className="text-slate-600 text-sm">
                <strong className="text-slate-800">How to clear:</strong> You
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-3">
                  ...
                  <div className="bg-transparent rounded-lg p-4 border border-white/80">
                    <p className="font-semibold text-slate-800 mb-2">Safari</p>
                    <p className="text-slate-500 text-sm">
              ...
              <div>
                ...
                <ul className="list-disc pl-6 text-slate-600 space-y-2">
                  <li>
                    <strong className="text-slate-800">Do Not Track (DNT):</strong>{' '}
                  ...
                  <li>
                    <strong className="text-slate-800">Browser Settings:</strong>{' '}
              ...
              <div className="bg-amber-50 rounded-xl p-6 border border-amber-200">
                <p className="text-slate-600">
                  <strong className="text-slate-800">Important:</strong> Blocking
          ...
          <section className="relative overflow-hidden rounded-2xl p-8 themed-section-bg">
            ...
            <div className="space-y-3 text-slate-600">
              <p>
                <strong className="text-slate-800">Cookie Questions:</strong>
              </p>
              <p>
                Privacy:{' '}
                <a
