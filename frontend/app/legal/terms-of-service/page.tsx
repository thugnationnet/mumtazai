    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-14 md:py-20 overflow-hidden rounded-b-[2rem] themed-section-bg">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent mb-4">Terms of Service</h1>
        ...
        <div className="space-y-12">
          ...
          <section className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border border-white/60 shadow-lg">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              Welcome to Mumtaz AI. By accessing or using our platform at{' '}
              <a
          ...
          <section className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border border-white/60 shadow-lg">
            ...
            <p className="text-slate-600 mb-4">
              Mumtaz AI operates a multi-application AI development platform
            ...
            <div className="space-y-4 mb-6">
              <div className="bg-transparent rounded-xl p-5 border border-white/80">
                ...
                <p className="text-slate-400 text-xs">Accessible at: mumtaz.ai → Neural Chat → Canvas</p>
              </div>
              <div className="bg-transparent rounded-xl p-5 border border-white/80">
                ...
                <p className="text-slate-400 text-xs">Stack: React 19 · TypeScript · Vite 6 · Zustand · Monaco Editor</p>
              </div>
              <div className="bg-transparent rounded-xl p-5 border border-white/80">
                ...
                <p className="text-slate-500 text-sm mb-1">
                  ...
                  All AI processing is handled through Mumtaz AI&apos;s own platform API keys.
                </p>
                <p className="text-slate-400 text-xs">Accessible at: mumtaz.ai → /gen-craft-pro/</p>
              </div>
              <div className="bg-transparent rounded-xl p-5 border border-white/80">
            ...
            <h3 className="text-xl font-semibold mb-3 text-slate-800">2.1 AI Provider Network</h3>
            <p className="text-slate-600 mb-3">
              Our services process your prompts and code through the following
              third-party AI providers. <strong>All API calls are made through Mumtaz AI&apos;s own platform API keys</strong> on your behalf —
              ...
              <table className="w-full text-sm border-collapse border border-white/80 rounded-lg overflow-hidden">
                <thead>
                  <tr className="bg-white/40 text-slate-800">
                    <th className="text-left p-3 border border-white/80 font-semibold">Provider</th>
                    <th className="text-left p-3 border border-white/80 font-semibold">Models Used</th>
                    <th className="text-left p-3 border border-white/80 font-semibold">Data Training Policy</th>
                  </tr>
                </thead>
                <tbody className="text-slate-600">
                  <tr><td className="p-3 border border-white/80">Anthropic</td><td className="p-3 border border-white/80">Claude Sonnet 4, Opus 4, Haiku</td><td className="p-3 border border-white/80 text-green-700 font-medium">✅ Does NOT use API data for training</td></tr>
                  <tr className="bg-transparent"><td className="p-3 border border-white/80">OpenAI</td><td className="p-3 border border-white/80">GPT-4o, GPT-4o Mini, TTS, DALL·E 3</td><td className="p-3 border border-white/80 text-green-700 font-medium">✅ API data not used for training (API key tier)</td></tr>
                  <tr><td className="p-3 border border-white/80">Google</td><td className="p-3 border border-white/80">Gemini 2.5 Pro, Gemini 2.5 Flash</td><td className="p-3 border border-white/80 text-green-700 font-medium">✅ Enterprise Cloud data processing terms</td></tr>
                  <tr className="bg-transparent"><td className="p-3 border border-white/80">Mistral AI</td><td className="p-3 border border-white/80">Mistral Large, Codestral</td><td className="p-3 border border-white/80 text-green-700 font-medium">✅ GDPR-compliant; no API training</td></tr>
                  <tr><td className="p-3 border border-white/80">xAI</td><td className="p-3 border border-white/80">Grok 3, Grok 3 Mini</td><td className="p-3 border border-white/80 text-green-700 font-medium">✅ Enterprise API terms; no training</td></tr>
                  <tr className="bg-transparent"><td className="p-3 border border-white/80">Groq</td><td className="p-3 border border-white/80">LLaMA 3.3 70B (speed-optimized)</td><td className="p-3 border border-white/80 text-green-700 font-medium">✅ Inference only; no persistent storage</td></tr>
                  <tr><td className="p-3 border border-white/80">Cerebras</td><td className="p-3 border border-white/80">LLaMA 3.3 70B (wafer-scale inference)</td><td className="p-3 border border-white/80 text-green-700 font-medium">✅ Inference only; no persistent storage</td></tr>
                  <tr className="bg-transparent"><td className="p-3 border border-white/80">HuggingFace</td><td className="p-3 border border-white/80">Open-source model inference</td><td className="p-3 border border-white/80 text-green-700 font-medium">✅ Inference API; enterprise terms</td></tr>
                  <tr><td className="p-3 border border-white/80">Ollama</td><td className="p-3 border border-white/80">Local/self-hosted open-source models</td><td className="p-3 border border-white/80 text-green-700 font-medium">✅ Runs on our servers; data never leaves our infra</td></tr>
                  <tr className="bg-transparent"><td className="p-3 border border-white/80">fal.ai / Minimax</td><td className="p-3 border border-white/80">Video generation models</td><td className="p-3 border border-white/80 text-green-700 font-medium">✅ Processing only; no retention after generation</td></tr>
                  <tr><td className="p-3 border border-white/80">Azure AI Vision</td><td className="p-3 border border-white/80">Image-to-code analysis</td><td className="p-3 border border-white/80 text-green-700 font-medium">✅ Microsoft enterprise DPA; no training</td></tr>
                </tbody>
              </table>
            </div>
            ...
            <h3 className="text-xl font-semibold mb-3 text-slate-800">2.2 Credit-Based Billing</h3>
            <p className="text-slate-600 mb-3">
            ...
            <div className="bg-blue-50 rounded-xl p-6 border border-blue-200 mb-4">
              <h4 className="text-lg font-semibold text-slate-800 mb-3">Credit Packs (One-Time Purchase, No Subscription)</h4>
                ...
                <table className="w-full text-sm border-collapse border border-white/80 rounded-lg overflow-hidden">
                  <thead>
                    <tr className="bg-blue-100 text-slate-800">
                      <th className="text-left p-3 border border-white/80 font-semibold">Pack</th>
                      <th className="text-left p-3 border border-white/80 font-semibold">Credits</th>
                      <th className="text-left p-3 border border-white/80 font-semibold">Bonus</th>
                      <th className="text-left p-3 border border-white/80 font-semibold">Total</th>
                      <th className="text-left p-3 border border-white/80 font-semibold">Price (USD)</th>
                    </tr>
                  </thead>
                  <tbody className="text-slate-600">
                    <tr><td className="p-3 border border-white/80">Starter Pack</td><td className="p-3 border border-white/80">10</td><td className="p-3 border border-white/80">—</td><td className="p-3 border border-white/80">10</td><td className="p-3 border border-white/80 font-semibold">$5</td></tr>
                    <tr className="bg-transparent"><td className="p-3 border border-white/80">Pro Pack</td><td className="p-3 border border-white/80">50</td><td className="p-3 border border-white/80">+5</td><td className="p-3 border border-white/80">55</td><td className="p-3 border border-white/80 font-semibold">$20</td></tr>
                    <tr><td className="p-3 border border-white/80">Power Pack</td><td className="p-3 border border-white/80">100</td><td className="p-3 border border-white/80">+15</td><td className="p-3 border border-white/80">115</td><td className="p-3 border border-white/80 font-semibold">$35</td></tr>
                    <tr className="bg-transparent"><td className="p-3 border border-white/80">Enterprise Pack</td><td className="p-3 border border-white/80">500</td><td className="p-3 border border-white/80">+100</td><td className="p-3 border border-white/80">600</td><td className="p-3 border border-white/80 font-semibold">$150</td></tr>
                  </tbody>
                </table>
              </div>
            </div>
            ...
            <div className="bg-green-50 rounded-xl p-6 border border-green-200 mb-4">
              <h4 className="text-lg font-semibold text-slate-800 mb-3">Credit Costs Per AI Action</h4>
              <p className="text-slate-600 text-sm mb-3">
                ...
                <table className="w-full text-sm border-collapse border border-white/80 rounded-lg overflow-hidden">
                  <thead>
                    <tr className="bg-green-100 text-slate-800">
                      <th className="text-left p-3 border border-white/80 font-semibold">AI Action</th>
                      <th className="text-left p-3 border border-white/80 font-semibold">Approx. Cost</th>
                    </tr>
                  </thead>
                  <tbody className="text-slate-600">
                    <tr><td className="p-3 border border-white/80">Chat Message (standard)</td><td className="p-3 border border-white/80">~0.01–0.15 credits</td></tr>
                    <tr className="bg-transparent"><td className="p-3 border border-white/80">Chat Message (advanced / long context)</td><td className="p-3 border border-white/80">~0.15–0.75 credits</td></tr>
                    <tr><td className="p-3 border border-white/80">Code Generation (per request)</td><td className="p-3 border border-white/80">~0.03–0.50 credits</td></tr>
                    <tr className="bg-transparent"><td className="p-3 border border-white/80">AI Image Generation (HD)</td><td className="p-3 border border-white/80">~0.80 credits</td></tr>
                    <tr><td className="p-3 border border-white/80">AI Video Generation</td><td className="p-3 border border-white/80">5–8 credits</td></tr>
                    <tr className="bg-transparent"><td className="p-3 border border-white/80">Text-to-Speech</td><td className="p-3 border border-white/80">~0.15 per 1K characters</td></tr>
                    <tr><td className="p-3 border border-white/80">Image-to-Code Analysis</td><td className="p-3 border border-white/80">~0.10–0.30 credits</td></tr>
                    <tr className="bg-transparent"><td className="p-3 border border-white/80">Web Search &amp; Deep Research</td><td className="p-3 border border-white/80">~0.05–0.20 credits</td></tr>
                  </tbody>
                </table>
              </div>
            </div>

            <div className="bg-transparent rounded-xl p-6 border border-white/80 mb-4">
              <h4 className="text-lg font-semibold text-slate-800 mb-3">Credit Policies</h4>
            ...
            <div className="bg-purple-50 rounded-xl p-6 border border-purple-200 mb-6">
              <h4 className="text-lg font-semibold text-slate-800 mb-3">Apps Using Credit-Based Billing</h4>
              <p className="text-slate-600 text-sm mb-3">
                ...
                <table className="w-full text-sm border-collapse border border-white/80 rounded-lg overflow-hidden">
                  <thead>
                    <tr className="bg-purple-100 text-slate-800">
                      <th className="text-left p-3 border border-white/80 font-semibold">Application</th>
                      <th className="text-left p-3 border border-white/80 font-semibold">Description</th>
                      <th className="text-left p-3 border border-white/80 font-semibold">Key AI Features</th>
                    </tr>
                  </thead>
                  <tbody className="text-slate-600">
                    <tr><td className="p-3 border border-white/80 font-medium">Neural Chat</td><td className="p-3 border border-white/80">AI conversational assistant with 18 personalities</td><td className="p-3 border border-white/80">Chat, voice calls, TTS, image gen, web search, deep research</td></tr>
                    <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Canvas Studio</td><td className="p-3 border border-white/80">AI app builder &amp; code generator at apps.mumtaz.ai</td><td className="p-3 border border-white/80">Code generation, live preview, Sandpack runtime, image-to-code, video gen, deployment</td></tr>
                    <tr><td className="p-3 border border-white/80 font-medium">GenCraft Pro</td><td className="p-3 border border-white/80">AI full-stack app builder with dual editors</td><td className="p-3 border border-white/80">Full app generation, Monaco/CodeMirror editors, 40+ languages, deploy to 5 platforms</td></tr>
                    <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Maula Editor</td><td className="p-3 border border-white/80">Full cloud IDE at maula.dev with in-browser runtime</td><td className="p-3 border border-white/80">268 AI tools, AI copilot, terminal, in-browser Node.js, Git, collaboration</td></tr>
                  </tbody>
                </table>
              </div>
              <p className="text-slate-400 text-xs mt-3">
                Note: GenCraft Pro also offers recurring subscription plans (🎁 50% OFF Welcome Gift: $10/day (was $20), $15/week (was $30), $30/month (was $60), $300/year (was $600)). Canvas Build (Canvas Studio) offers recurring subscription plans (🎁 50% OFF Welcome Gift: $10/day (was $20), $20/week (was $40), $50/month (was $100), $500/year (was $1000)). Subscriptions auto-renew at the chosen cadence and can be cancelled anytime from your account dashboard.
                AI Agent access uses per-agent pricing ($5/day, $7/week, $30/month, or $300/year per agent — one-time purchase, no auto-renewal).
                The credit system is separate from these subscription/per-agent pricing models.
              </p>
            </div>

            <h3 className="text-xl font-semibold mb-3 text-slate-800">2.3 Sandbox Code Execution</h3>
            <p className="text-slate-600 mb-3">
          ...
          <section className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border border-white/60 shadow-lg">
            <h2 className="text-3xl font-bold mb-6 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
              3. Pricing and Daily Access
            </h2>

            <div className="bg-white/40 backdrop-blur-lg rounded-2xl p-6 mb-6 border border-blue-200 shadow-lg">
              <h3 className="text-2xl font-bold text-slate-800 mb-3">
                💵 $5 Daily Access
              </h3>
              <p className="text-slate-600 mb-4">
                New users can access our platform for just{' '}
                <strong className="text-blue-600">$5.00 USD per day</strong>.
                This low-cost access gives you full use of:
              </p>
            ...
            <div className="space-y-4">
              <div>
                ...
                <ul className="list-disc pl-6 text-slate-600 space-y-2">
                  ...
                  <li>Choose from $5/day, $7/week, $30/month, or $300/year per agent — one-time purchase, no auto-renewal</li>
                  <li>
              ...
              <div>
                ...
                <p className="text-slate-600 mb-2">We accept:</p>
              ...
              <div className="bg-amber-50 rounded-xl p-6 border border-amber-200">
                ...
                <p className="text-slate-600 mb-3">
                  ...
                  Given the low-cost nature of our service (starting at $5 per day) and
              ...
              <div>
                ...
                <div className="bg-red-50 rounded-xl p-4 border border-red-200">
                  <p className="text-slate-600">
                    ...
                    <strong className="text-slate-800">18 years old</strong> to
          ...
          <section className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border border-white/60 shadow-lg">
            ...
            <div className="bg-white/40 backdrop-blur-lg rounded-2xl p-6 mb-6 border border-green-200 shadow-lg">
            ...
            <div className="bg-white/40 backdrop-blur-lg rounded-2xl p-6 border border-green-200 shadow-lg">
              <h3 className="text-xl font-bold text-slate-800 mb-3">
                ⚡ Agent Memory System
              </h3>
              <p className="text-slate-600">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="bg-red-50 rounded-xl p-6 border border-red-200">
                  <p className="text-slate-600 mb-3">
                    TO THE MAXIMUM EXTENT PERMITTED BY LAW, MUMTAZ AI SHALL
                    NOT BE LIABLE FOR:
                  </p>
                  <ul className="list-disc pl-6 text-slate-600 space-y-2">
                    <li>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="bg-blue-50 rounded-xl p-4 border border-blue-200 mt-3">
                  <h4 className="text-sm font-semibold text-slate-800 mb-2">Regional Jurisdiction Notes</h4>
                  <ul className="list-disc pl-6 text-slate-600 space-y-2 text-sm">
                    <li>
          ...
          <section id="securetrace-terms" className="scroll-mt-24">
            ...
            <div className="space-y-5 text-sm text-slate-600">
              <div>
                <h3 className="text-lg font-semibold mb-2 text-slate-800">Consent to Tracking</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2 text-slate-800">Lost-Device Report &amp; Verification</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2 text-slate-800">One-Device License</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2 text-slate-800">Remote Commands</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2 text-slate-800">Location Unlock Payment</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2 text-slate-800">Limitation of Liability</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2 text-slate-800">Legal Compliance</h3>
                <p>
