...
function ArticlePopup({ article, onClose }: ArticlePopupProps) {
  return (
    <div className="fixed inset-0 bg-slate-400 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fadeIn">
      <div className="bg-white/40 backdrop-blur-lg rounded-2xl max-w-3xl border border-white/60 shadow-lg w-full max-h-[85vh] flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-white/80 bg-transparent">
          <h3 className="text-xl font-bold text-slate-800">{article.title}</h3>
          <button
            onClick={onClose}
            className="p-2 hover:bg-gray-100 rounded-lg transition-colors text-slate-400 hover:text-slate-600"
          >
            <X size={20} />
          </button>
        </div>
        ...
        {/* Footer */}
        <div className="p-4 border-t border-white/80 bg-transparent">
          <button
            onClick={onClose}
...
Our Compliance:
Mumtaz AI does not knowingly collect information from children under 13. Our services are intended for users 18 years and older.`,
    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-14 md:py-20 overflow-hidden rounded-b-[2rem] themed-section-bg">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent mb-4">Privacy Policy</h1>
        ...
        <div className="space-y-12">
          ...
          <section className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border border-white/60 shadow-lg">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              Welcome to Mumtaz AI (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;). We operate a global
          ...
          <section className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border border-white/60 shadow-lg">
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="list-disc pl-6 text-slate-600 space-y-2">
                  <li>
                    <strong className="text-slate-800">Identifiers:</strong>{' '}
                    Name, email address, username, password, phone number
                  </li>
                  <li>
                    <strong className="text-slate-800">Profile Information:</strong>{' '}
                    Company name, job title, profile picture, bio
                  </li>
                  <li>
                    <strong className="text-slate-800">Financial Information:</strong>{' '}
                  ...
                  <li>
                    <strong className="text-slate-800">Content Data:</strong>{' '}
                    Files, documents, images, code, and prompts submitted to AI agents
                  </li>
                  <li>
                    <strong className="text-slate-800">Audio/Visual Data:</strong>{' '}
                    Voice recordings when using voice-chat features, uploaded images/screenshots
                  </li>
                  <li>
                    <strong className="text-slate-800">Optional Profile Data:</strong>{' '}
                    Preferred name, age, gender, nationality (for AI personalization and localization)
                  </li>
                  <li>
                    <strong className="text-slate-800">User-Supplied Credentials (Encrypted):</strong>{' '}
              ...
              <div>
                ...
                <ul className="list-disc pl-6 text-slate-600 space-y-2">
                  ...
                  <li>
                    <strong className="text-slate-800">Geolocation Data:</strong>{' '}
              ...
              <div>
                ...
                <div className="bg-blue-50 rounded-xl p-5 border border-blue-200 mt-4">
                  <h4 className="font-semibold text-slate-800 mb-2">Agent Memory System</h4>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 text-slate-600 space-y-2">
                  ...
                  <li>
                    <strong className="text-slate-800">Precise geolocation:</strong>{' '}
                    We do NOT collect precise geolocation. Only approximate location from IP address.
                  </li>
                  <li>
                    <strong className="text-slate-800">Contents of communications:</strong>{' '}
          ...
          <section className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border border-white/60 shadow-lg">
            ...
            <div className="space-y-4">
              <div className="bg-transparent rounded-xl p-6 border border-white/80">
            ...
            <div className="space-y-4">
              <div>
                ...
                <ul className="list-disc pl-6 text-slate-600 space-y-1">
                  ...
                  <li><strong>AI model providers (accessed via Mumtaz AI&apos;s own API keys — users never need provider accounts):</strong>
                    ...
                    <p className="mt-2 text-sm"><strong>Important:</strong> All AI API calls are made through Mumtaz AI&apos;s own platform API keys on your behalf. You do not need accounts with any AI provider. Your prompts and code context may be sent to generate responses. We do <strong>NOT</strong> include your email, name, password, credentials, or payment info in AI prompts. We do <strong>NOT</strong> sell, share, or license your data to any third party. We do <strong>NOT</strong> use your data to train, fine-tune, or improve any AI models.</p>
                  </li>
              ...
              <div className="mt-4">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border-collapse border border-white/80 rounded-lg overflow-hidden">
                    <thead>
                      <tr className="bg-white/40 text-slate-800">
                        <th className="text-left p-3 border border-white/80 font-semibold">Category of PI</th>
                        <th className="text-left p-3 border border-white/80 font-semibold">Disclosed To</th>
                        <th className="text-left p-3 border border-white/80 font-semibold">Purpose</th>
                      </tr>
                    </thead>
                    <tbody className="text-slate-600">
                      <tr>
                        <td className="p-3 border border-white/80">A. Identifiers</td>
                        <td className="p-3 border border-white/80">Cloud host, email service, payment processor</td>
                        <td className="p-3 border border-white/80">Account management, billing, support</td>
                      </tr>
                      <tr className="bg-transparent">
                        <td className="p-3 border border-white/80">B. Customer records</td>
                        <td className="p-3 border border-white/80">Payment processor (Stripe)</td>
                        <td className="p-3 border border-white/80">Payment processing</td>
                      </tr>
                      <tr>
                        <td className="p-3 border border-white/80">D. Commercial information</td>
                        <td className="p-3 border border-white/80">Payment processor</td>
                        <td className="p-3 border border-white/80">Transaction processing, invoicing</td>
                      </tr>
                      <tr className="bg-transparent">
                        <td className="p-3 border border-white/80">F. Internet activity</td>
                        <td className="p-3 border border-white/80">Internal analytics (self-hosted)</td>
                        <td className="p-3 border border-white/80">Service improvement, fraud detection</td>
                      </tr>
                      <tr>
                        <td className="p-3 border border-white/80">G. Geolocation (approx.)</td>
                        <td className="p-3 border border-white/80">Cloud host, analytics</td>
                        <td className="p-3 border border-white/80">Service delivery, localization</td>
                      </tr>
                      <tr className="bg-transparent">
                        <td className="p-3 border border-white/80">H. Audio/visual (voice chat, images)</td>
                        <td className="p-3 border border-white/80">AI model providers, Azure AI Vision, fal.ai</td>
                        <td className="p-3 border border-white/80">Voice-to-text, AI interaction, image-to-code, video generation</td>
                      </tr>
                      <tr>
                        <td className="p-3 border border-white/80">K. Inferences (agent memories)</td>
                        <td className="p-3 border border-white/80">Not disclosed to third parties</td>
                        <td className="p-3 border border-white/80">Internal AI personalization only</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
          ...
          <section className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border border-white/60 shadow-lg">
            ...
            <div className="bg-blue-50 rounded-xl p-5 border border-blue-200">
              <p className="text-slate-600 mb-3">
                <strong className="text-slate-800">Retention Periods:</strong>
              </p>
              <ul className="list-disc pl-6 text-slate-600 space-y-2">
                <li>
          ...
          <section className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border border-white/60 shadow-lg">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="bg-transparent rounded-xl p-4 border border-white/80">
                ...
                <p className="text-slate-500 text-sm">Request a copy of your personal data we hold</p>
              </div>
              <div className="bg-transparent rounded-xl p-4 border border-white/80">
                <h3 className="font-semibold text-blue-700 mb-2">✓ Right to Rectification / Correction</h3>
                <p className="text-slate-500 text-sm">Correct inaccurate or incomplete personal data</p>
              </div>
              <div className="bg-transparent rounded-xl p-4 border border-white/80">
                <h3 className="font-semibold text-blue-700 mb-2">✓ Right to Erasure / Deletion</h3>
                <p className="text-slate-500 text-sm">Request deletion of your personal data, subject to legal retention obligations</p>
              </div>
              <div className="bg-transparent rounded-xl p-4 border border-white/80">
                <h3 className="font-semibold text-blue-700 mb-2">✓ Right to Data Portability</h3>
                <p className="text-slate-500 text-sm">Receive your data in a structured, machine-readable format (JSON or CSV)</p>
              </div>
              <div className="bg-transparent rounded-xl p-4 border border-white/80">
                <h3 className="font-semibold text-blue-700 mb-2">✓ Right to Object / Opt-Out</h3>
                <p className="text-slate-500 text-sm">Object to processing of your personal data for certain purposes</p>
              </div>
              <div className="bg-transparent rounded-xl p-4 border border-white/80">
                <h3 className="font-semibold text-blue-700 mb-2">✓ Right to Withdraw Consent</h3>
                <p className="text-slate-500 text-sm">Withdraw consent at any time without affecting prior processing</p>
              </div>
            </div>
            ...
            <div className="mt-6 bg-blue-50 rounded-xl p-6 border border-blue-200">
              ...
              <ul className="list-disc pl-6 text-slate-600 space-y-1">
                ...
                <li>
                  <strong>Mailing address:</strong> Mumtaz AI, Attn: Privacy Team (see Section 15)
                </li>
              </ul>
          ...
          {/* ───────────────── 7. GDPR COMPLIANCE ───────────────── */}
          {/* ═══════════════════════════════════════════════════════════ */}
          <section className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border-2 border-green-200">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Mumtaz AI is the data controller responsible for your personal
                  ...
                  <table className="w-full text-sm border-collapse border border-white/80 rounded-lg overflow-hidden">
                    <thead>
                      <tr className="bg-green-50 text-slate-800">
                        <th className="text-left p-3 border border-white/80 font-semibold">Processing Activity</th>
                        <th className="text-left p-3 border border-white/80 font-semibold">Lawful Basis</th>
                      </tr>
                    </thead>
                    <tbody className="text-slate-600">
                      <tr>
                        <td className="p-3 border border-white/80">Creating &amp; maintaining your account</td>
                        <td className="p-3 border border-white/80">Performance of contract (Art. 6(1)(b))</td>
                      </tr>
                      <tr className="bg-transparent">
                        <td className="p-3 border border-white/80">Providing AI agent services &amp; features</td>
                        <td className="p-3 border border-white/80">Performance of contract (Art. 6(1)(b))</td>
                      </tr>
                      <tr>
                        <td className="p-3 border border-white/80">AI code generation &amp; tool execution</td>
                        <td className="p-3 border border-white/80">Performance of contract (Art. 6(1)(b))</td>
                      </tr>
                      <tr className="bg-transparent">
                        <td className="p-3 border border-white/80">Credit/billing management</td>
                        <td className="p-3 border border-white/80">Performance of contract (Art. 6(1)(b))</td>
                      </tr>
                      <tr>
                        <td className="p-3 border border-white/80">Page view &amp; visitor session tracking</td>
                        <td className="p-3 border border-white/80">Legitimate interest (Art. 6(1)(f)) — analytics</td>
                      </tr>
                      <tr className="bg-transparent">
                        <td className="p-3 border border-white/80">Security monitoring (login attempts, lockout)</td>
                        <td className="p-3 border border-white/80">Legitimate interest (Art. 6(1)(f)) — security</td>
                      </tr>
                      <tr>
                        <td className="p-3 border border-white/80">Processing payments &amp; billing</td>
                        <td className="p-3 border border-white/80">Performance of contract (Art. 6(1)(b))</td>
                      </tr>
                      <tr className="bg-transparent">
                        <td className="p-3 border border-white/80">Sending transactional emails</td>
                        <td className="p-3 border border-white/80">Performance of contract (Art. 6(1)(b))</td>
                      </tr>
                      <tr>
                        <td className="p-3 border border-white/80">Analytics &amp; service improvement</td>
                        <td className="p-3 border border-white/80">Legitimate interest (Art. 6(1)(f)) — improving our services</td>
                      </tr>
                      <tr className="bg-transparent">
                        <td className="p-3 border border-white/80">Fraud prevention &amp; security</td>
                        <td className="p-3 border border-white/80">Legitimate interest (Art. 6(1)(f)) — protecting our platform</td>
                      </tr>
                      <tr>
                        <td className="p-3 border border-white/80">Marketing communications</td>
                        <td className="p-3 border border-white/80">Consent (Art. 6(1)(a)) — opt-in only</td>
                      </tr>
                      <tr className="bg-transparent">
                        <td className="p-3 border border-white/80">Optional profile data (age, gender, nationality)</td>
                        <td className="p-3 border border-white/80">Consent (Art. 6(1)(a))</td>
                      </tr>
                      <tr>
                        <td className="p-3 border border-white/80">Agent memory storage</td>
                        <td className="p-3 border border-white/80">Consent (Art. 6(1)(a)) — user can disable</td>
                      </tr>
                      <tr className="bg-transparent">
                        <td className="p-3 border border-white/80">Tax/financial record-keeping</td>
                        <td className="p-3 border border-white/80">Legal obligation (Art. 6(1)(c))</td>
                      </tr>
                      <tr>
                        <td className="p-3 border border-white/80">Responding to legal requests</td>
                        <td className="p-3 border border-white/80">Legal obligation (Art. 6(1)(c))</td>
                      </tr>
                    </tbody>
                  </table>
          ...
          {/* ═══════════════════════════════════════════════════════════ */}
          <section className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border-2 border-blue-200">
            <div className="flex items-center gap-3 mb-6">
              <ComplianceBadge icon={Scale} label="CCPA/CPRA" color="bg-blue-100 text-blue-800" />
                  ...
                  <table className="w-full text-sm border-collapse border border-white/80 rounded-lg overflow-hidden">
                    <thead>
                      <tr className="bg-blue-50 text-slate-800">
                        <th className="text-left p-3 border border-white/80 font-semibold">Category</th>
                        <th className="text-left p-3 border border-white/80 font-semibold">Examples</th>
                        <th className="text-center p-3 border border-white/80 font-semibold">Collected?</th>
                      </tr>
                    </thead>
                    <tbody className="text-slate-600">
                      <tr>
                        <td className="p-3 border border-white/80 font-medium">A. Identifiers</td>
                        <td className="p-3 border border-white/80">Name, email, username, IP address, account name</td>
                        <td className="p-3 border border-white/80 text-center text-green-600 font-bold">Yes</td>
                      </tr>
                      <tr className="bg-transparent">
                        <td className="p-3 border border-white/80 font-medium">B. Customer records</td>
                        <td className="p-3 border border-white/80">Name, address, phone, payment information</td>
                        <td className="p-3 border border-white/80 text-center text-green-600 font-bold">Yes</td>
                      </tr>
                      <tr>
                        <td className="p-3 border border-white/80 font-medium">C. Protected classifications</td>
                        <td className="p-3 border border-white/80">Age, gender (optional profile fields)</td>
                        <td className="p-3 border border-white/80 text-center text-green-600 font-bold">Yes*</td>
                      </tr>
                      <tr className="bg-transparent">
                        <td className="p-3 border border-white/80 font-medium">D. Commercial information</td>
                        <td className="p-3 border border-white/80">Purchase history, subscription plan, usage records</td>
                        <td className="p-3 border border-white/80 text-center text-green-600 font-bold">Yes</td>
                      </tr>
                      <tr>
                        <td className="p-3 border border-white/80 font-medium">E. Biometric information</td>
                        <td className="p-3 border border-white/80">Fingerprints, voice prints, facial recognition data</td>
                        <td className="p-3 border border-white/80 text-center text-red-500 font-bold">No</td>
                      </tr>
                      <tr className="bg-transparent">
                        <td className="p-3 border border-white/80 font-medium">F. Internet / network activity</td>
                        <td className="p-3 border border-white/80">Browsing history, interactions with our platform, search queries</td>
                        <td className="p-3 border border-white/80 text-center text-green-600 font-bold">Yes</td>
                      </tr>
                      <tr>
                        <td className="p-3 border border-white/80 font-medium">G. Geolocation data</td>
                        <td className="p-3 border border-white/80">Approximate location from IP address</td>
                        <td className="p-3 border border-white/80 text-center text-green-600 font-bold">Yes</td>
                      </tr>
                      <tr className="bg-transparent">
                        <td className="p-3 border border-white/80 font-medium">H. Audio / visual data</td>
                        <td className="p-3 border border-white/80">Voice recordings (voice chat), uploaded images/videos</td>
                        <td className="p-3 border border-white/80 text-center text-green-600 font-bold">Yes</td>
                      </tr>
                      <tr>
                        <td className="p-3 border border-white/80 font-medium">I. Professional / employment info</td>
                        <td className="p-3 border border-white/80">Job title, company name (optional profile fields)</td>
                        <td className="p-3 border border-white/80 text-center text-green-600 font-bold">Yes</td>
                      </tr>
                      <tr className="bg-transparent">
                        <td className="p-3 border border-white/80 font-medium">J. Education information</td>
                        <td className="p-3 border border-white/80">Education records</td>
                        <td className="p-3 border border-white/80 text-center text-red-500 font-bold">No</td>
                      </tr>
                      <tr>
                        <td className="p-3 border border-white/80 font-medium">K. Inferences</td>
                        <td className="p-3 border border-white/80">Agent preferences, usage patterns, content interests</td>
                        <td className="p-3 border border-white/80 text-center text-green-600 font-bold">Yes</td>
                      </tr>
                      <tr className="bg-transparent">
                        <td className="p-3 border border-white/80 font-medium">L. Sensitive PI (CPRA)</td>
                        <td className="p-3 border border-white/80">Account login credentials; contents of messages to AI agents</td>
                        <td className="p-3 border border-white/80 text-center text-green-600 font-bold">Yes*</td>
                      </tr>
                    </tbody>
                  </table>
          ...
          {/* ═══════════════════════════════════════════════════════════ */}
          <section className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border-2 border-amber-200">
            <div className="flex items-center gap-3 mb-6">
              <ComplianceBadge icon={Globe} label="CalOPPA" color="bg-amber-100 text-amber-800" />
          ...
          <section className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border border-white/60 shadow-lg">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Mumtaz AI acts as the <strong>Data Controller</strong> for personal data
              ...
              <div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border-collapse border border-white/80 rounded-lg overflow-hidden">
                    <thead>
                      <tr className="bg-purple-50 text-slate-800">
                        <th className="text-left p-3 border border-white/80 font-semibold">Lawful Basis</th>
                        <th className="text-left p-3 border border-white/80 font-semibold">Processing Activity</th>
                      </tr>
                    </thead>
                    <tbody className="text-slate-600">
                      <tr><td className="p-3 border border-white/80 font-medium">Consent (Sec. 19)</td><td className="p-3 border border-white/80">Marketing communications, optional analytics</td></tr>
                      <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Contract Performance (Sec. 24(3))</td><td className="p-3 border border-white/80">Account creation, service delivery, payment processing, AI interactions</td></tr>
                      <tr><td className="p-3 border border-white/80 font-medium">Legal Obligation (Sec. 24(6))</td><td className="p-3 border border-white/80">Tax records, fraud prevention, regulatory compliance</td></tr>
                      <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Legitimate Interest (Sec. 24(5))</td><td className="p-3 border border-white/80">Security, service improvement, abuse prevention</td></tr>
                    </tbody>
                  </table>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border-collapse border border-white/80 rounded-lg overflow-hidden">
                    <thead>
                      <tr className="bg-purple-50 text-slate-800">
                        <th className="text-left p-3 border border-white/80 font-semibold">Right</th>
                        <th className="text-left p-3 border border-white/80 font-semibold">Description</th>
                      </tr>
                    </thead>
                    <tbody className="text-slate-600">
                      <tr><td className="p-3 border border-white/80 font-medium">Right to Access (Sec. 30)</td><td className="p-3 border border-white/80">Request access to your personal data and a copy thereof</td></tr>
                      <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Right to Data Portability (Sec. 31)</td><td className="p-3 border border-white/80">Receive your data in a structured, machine-readable format</td></tr>
                      <tr><td className="p-3 border border-white/80 font-medium">Right to Object (Sec. 32)</td><td className="p-3 border border-white/80">Object to processing based on legitimate interests or public interest</td></tr>
                      <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Right to Erasure (Sec. 33)</td><td className="p-3 border border-white/80">Request deletion or destruction of your personal data</td></tr>
                      <tr><td className="p-3 border border-white/80 font-medium">Right to Restrict Processing (Sec. 34)</td><td className="p-3 border border-white/80">Request restriction of processing in certain circumstances</td></tr>
                      <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Right to Rectification (Sec. 36)</td><td className="p-3 border border-white/80">Request correction of inaccurate or incomplete data</td></tr>
                      <tr><td className="p-3 border border-white/80 font-medium">Right to Withdraw Consent (Sec. 19)</td><td className="p-3 border border-white/80">Withdraw consent at any time (does not affect prior lawful processing)</td></tr>
                      <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Right to Complain (Sec. 73)</td><td className="p-3 border border-white/80">Lodge a complaint with the Personal Data Protection Committee (PDPC)</td></tr>
                    </tbody>
                  </table>
                </div>
              </div>
                  ...
                  <table className="w-full text-sm border-collapse border border-white/80 rounded-lg overflow-hidden">
                    <thead>
                      <tr className="bg-teal-50 text-slate-800">
                        <th className="text-left p-3 border border-white/80 font-semibold">Obligation</th>
                        <th className="text-left p-3 border border-white/80 font-semibold">How We Comply</th>
                      </tr>
                    </thead>
                    <tbody className="text-slate-600">
                      <tr><td className="p-3 border border-white/80 font-medium">Consent</td><td className="p-3 border border-white/80">We obtain consent before collecting, using, or disclosing personal data</td></tr>
                      <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Purpose Limitation</td><td className="p-3 border border-white/80">Data is used only for purposes stated in this policy</td></tr>
                      <tr><td className="p-3 border border-white/80 font-medium">Notification</td><td className="p-3 border border-white/80">Users are informed of purposes before or at the time of collection</td></tr>
                      <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Access &amp; Correction</td><td className="p-3 border border-white/80">Users can request access to and correction of their personal data</td></tr>
                      <tr><td className="p-3 border border-white/80 font-medium">Accuracy</td><td className="p-3 border border-white/80">We make reasonable efforts to ensure data accuracy</td></tr>
                      <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Protection</td><td className="p-3 border border-white/80">Reasonable security arrangements to protect personal data (TLS 1.2/1.3, AES-256)</td></tr>
                      <tr><td className="p-3 border border-white/80 font-medium">Retention Limitation</td><td className="p-3 border border-white/80">Data is not retained longer than necessary for the purposes</td></tr>
                      <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Transfer Limitation</td><td className="p-3 border border-white/80">Overseas transfers only to jurisdictions with comparable protection</td></tr>
                      <tr><td className="p-3 border border-white/80 font-medium">Data Breach Notification</td><td className="p-3 border border-white/80">We notify PDPC and affected individuals of significant data breaches</td></tr>
                      <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Accountability</td><td className="p-3 border border-white/80">We designate a Data Protection Officer and maintain compliance documentation</td></tr>
                    </tbody>
                  </table>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border-collapse border border-white/80 rounded-lg overflow-hidden">
                    ...
                    <tbody className="text-slate-600">
                      <tr><td className="p-3 border border-white/80 font-medium">Consent (Art. 4(1))</td><td className="p-3 border border-white/80">Marketing communications, optional features</td></tr>
                      <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Contract Performance (Art. 4(2))</td><td className="p-3 border border-white/80">Account creation, service delivery, payment processing</td></tr>
                      <tr><td className="p-3 border border-white/80 font-medium">Legal Obligation (Art. 4(3))</td><td className="p-3 border border-white/80">Compliance with UAE laws, tax requirements, fraud prevention</td></tr>
                      <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Legitimate Interest (Art. 4(5))</td><td className="p-3 border border-white/80">Platform security, service improvement, abuse prevention</td></tr>
                    </tbody>
                  </table>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border-collapse border border-white/80 rounded-lg overflow-hidden">
                    ...
                    <tbody className="text-slate-600">
                      <tr><td className="p-3 border border-white/80 font-medium">Right to Information (Art. 13)</td><td className="p-3 border border-white/80">Be informed about how your data is processed</td></tr>
                      <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Right to Access (Art. 14)</td><td className="p-3 border border-white/80">Request access to your personal data</td></tr>
                      <tr><td className="p-3 border border-white/80 font-medium">Right to Portability (Art. 15)</td><td className="p-3 border border-white/80">Request transfer of your data in a structured format</td></tr>
                      <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Right to Object to Automated Decisions (Art. 16)</td><td className="p-3 border border-white/80">Object to decisions based solely on automated processing including profiling</td></tr>
                      <tr><td className="p-3 border border-white/80 font-medium">Right to Correction/Erasure (Art. 17)</td><td className="p-3 border border-white/80">Request correction of inaccurate data or erasure of personal data</td></tr>
                      <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Right to Restrict/Stop Processing (Art. 18)</td><td className="p-3 border border-white/80">Request restriction or cessation of data processing</td></tr>
                      <tr><td className="p-3 border border-white/80 font-medium">Right to Withdraw Consent</td><td className="p-3 border border-white/80">Withdraw consent at any time without affecting prior lawful processing</td></tr>
                    </tbody>
                  </table>
                </div>
              </div>
          ...
          <section className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border border-white/60 shadow-lg">
            ...
            <div className="bg-green-50 rounded-xl p-6 border border-green-200 mb-6">
              ...
              <p className="text-green-800 text-sm">
                <strong>All AI calls are made through Mumtaz AI&apos;s own platform API keys.</strong> You never need an account with any AI provider.
            ...
            <h3 className="text-xl font-semibold mb-3 text-slate-800">What We Send to AI Providers</h3>
            <div className="overflow-x-auto mb-4">
              <table className="w-full text-sm border-collapse border border-white/80 rounded-lg overflow-hidden">
                <thead>
                  <tr className="bg-white/40 text-slate-800">
                    <th className="text-left p-3 border border-white/80 font-semibold">Data Type</th>
                    <th className="text-center p-3 border border-white/80 font-semibold">Sent?</th>
                    <th className="text-left p-3 border border-white/80 font-semibold">Purpose</th>
                  </tr>
                </thead>
                <tbody className="text-slate-600">
                  <tr>
                    <td className="p-3 border border-white/80">User text prompts</td>
                    <td className="p-3 border border-white/80 text-center text-green-600 font-bold">Yes</td>
                    <td className="p-3 border border-white/80">Generate AI response</td>
                  </tr>
                  <tr className="bg-transparent">
                    <td className="p-3 border border-white/80">Code files in current project</td>
                    <td className="p-3 border border-white/80 text-center text-green-600 font-bold">Yes</td>
                    <td className="p-3 border border-white/80">Contextual code generation</td>
                  </tr>
                  <tr>
                    <td className="p-3 border border-white/80">Conversation history</td>
                    <td className="p-3 border border-white/80 text-center text-green-600 font-bold">Yes</td>
                    <td className="p-3 border border-white/80">Multi-turn conversation context</td>
                  </tr>
                  <tr className="bg-transparent">
                    <td className="p-3 border border-white/80">User email / name / password</td>
                    <td className="p-3 border border-white/80 text-center text-red-500 font-bold">No</td>
                    <td className="p-3 border border-white/80">Never included in AI prompts</td>
                  </tr>
                  <tr>
                    <td className="p-3 border border-white/80">User credentials / deploy tokens</td>
                    <td className="p-3 border border-white/80 text-center text-red-500 font-bold">No</td>
                    <td className="p-3 border border-white/80">Never accessible to AI layer</td>
                  </tr>
                  <tr className="bg-transparent">
                    <td className="p-3 border border-white/80">Payment information</td>
                    <td className="p-3 border border-white/80 text-center text-red-500 font-bold">No</td>
                    <td className="p-3 border border-white/80">Never accessible to AI layer</td>
                  </tr>
                </tbody>
          ...
          <section className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border border-white/60 shadow-lg">
            ...
            <ul className="list-disc pl-6 text-slate-600 space-y-2">
              <li>
                <strong className="text-slate-800">Encryption:</strong> TLS 1.2/1.3
              ...
              <li>
                <strong className="text-slate-800">Infrastructure:</strong> AWS
              ...
              <li>
                <strong className="text-slate-800">Credential Separation:</strong>{' '}
              ...
              <li>
                <strong className="text-slate-800">Sandbox Isolation:</strong>{' '}
                User code execution runs in isolated AWS ECS Fargate containers (one per session)
              </li>
              <li>
                <strong className="text-slate-800">Regular Audits:</strong>{' '}
                Third-party security assessments and dependency vulnerability scanning
              </li>
              <li>
                <strong className="text-slate-800">Data Backup:</strong> Regular
          ...
          <section className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border border-white/60 shadow-lg">
            ...
            <div className="bg-red-50 rounded-xl p-6 border border-red-200">
              <p className="text-slate-600 mb-3">
                <strong className="text-slate-800">Age Restriction:</strong> Our
          ...
          <section className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border border-white/60 shadow-lg">
            ...
            <div className="overflow-x-auto mb-4">
              <table className="w-full text-sm border-collapse border border-white/80 rounded-lg overflow-hidden">
                <thead>
                  <tr className="bg-white/40 text-slate-800">
                    <th className="text-left p-3 border border-white/80 font-semibold">Cookie Type</th>
                    <th className="text-left p-3 border border-white/80 font-semibold">Purpose</th>
                    <th className="text-left p-3 border border-white/80 font-semibold">Duration</th>
                    <th className="text-left p-3 border border-white/80 font-semibold">Required?</th>
                  </tr>
                </thead>
                <tbody className="text-slate-600">
                  <tr>
                    <td className="p-3 border border-white/80 font-medium">Essential</td>
                    <td className="p-3 border border-white/80">
                    ...
                    <td className="p-3 border border-white/80">Session / 7 days</td>
                    <td className="p-3 border border-white/80">Yes</td>
                  </tr>
                  <tr className="bg-transparent">
                    <td className="p-3 border border-white/80 font-medium">Preference</td>
                    <td className="p-3 border border-white/80">Theme (dark mode), AI model/provider selection, display settings</td>
                    <td className="p-3 border border-white/80">1 year</td>
                    <td className="p-3 border border-white/80">No — opt-out</td>
                  </tr>
                  <tr>
                    <td className="p-3 border border-white/80 font-medium">Analytics</td>
                    <td className="p-3 border border-white/80">Page views, feature engagement, usage patterns (self-hosted — no Google Analytics)</td>
                    <td className="p-3 border border-white/80">1 year</td>
                    <td className="p-3 border border-white/80">No — opt-out</td>
                  </tr>
                </tbody>
          ...
          <section className="relative overflow-hidden rounded-2xl p-8 themed-section-bg">
            ...
            <h2 className="text-3xl font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent mb-6">19. Contact Us</h2>
            <div className="space-y-4 text-slate-600">
              <div>
                <p className="text-slate-800 font-semibold mb-1">Data Controller / Business:</p>
                <p>Mumtaz AI</p>
              </div>
              <div>
                <p className="text-slate-800 font-semibold mb-1">Data Protection Officer (GDPR):</p>
                <p>
                  Email:{' '}
                  <a href="mailto:dpo@mumtaz.ai" className="text-purple-600 hover:text-purple-800 underline">
                    dpo@mumtaz.ai
                  </a>
                </p>
              </div>
              <div>
                <p className="text-slate-800 font-semibold mb-1">Privacy Team (General / CCPA Requests):</p>
                <p>
                  Email:{' '}
                  <a href="mailto:privacy@mumtaz.ai" className="text-purple-600 hover:text-purple-800 underline">
                    privacy@mumtaz.ai
                  </a>
                </p>
              </div>
              <div>
                <p className="text-slate-800 font-semibold mb-1">General Support:</p>
                <p>
                  Email:{' '}
                  <a href="mailto:support@mumtaz.ai" className="text-purple-600 hover:text-purple-800 underline">
                    support@mumtaz.ai
                  </a>
                </p>
              </div>
              <div>
                ...
                <p>
                  <a href="https://mumtaz.ai" className="text-purple-600 hover:text-purple-800 underline">
                    https://mumtaz.ai
                  </a>
                </p>
              </div>

              <div className="mt-6 pt-6 border-t border-white/40 space-y-3">
                <p className="text-sm text-slate-600">
                  <strong className="text-slate-800">EU/EEA Representative (GDPR Art. 27):</strong>{' '}
                  For users in the European Union / EEA, you may contact our EU
                  representative regarding data protection matters at{' '}
                  <a href="mailto:eu-rep@mumtaz.ai" className="text-purple-600 underline">eu-rep@mumtaz.ai</a>.
                </p>
                <p className="text-sm text-slate-600">
                  <strong className="text-slate-800">UK Representative (UK GDPR):</strong>{' '}
                  For users in the United Kingdom, please contact{' '}
                  <a href="mailto:uk-rep@mumtaz.ai" className="text-purple-600 underline">uk-rep@mumtaz.ai</a>.
                </p>
                <p className="text-sm text-slate-600">
                  <strong className="text-slate-800">California Residents:</strong>{' '}
                  To exercise CCPA/CPRA rights, email{' '}
                  <a href="mailto:privacy@mumtaz.ai" className="text-purple-600 underline">privacy@mumtaz.ai</a>{' '}
                  with subject &quot;CCPA Request&quot; or use in-app Privacy Controls.
                </p>
                <p className="text-sm text-slate-600">
                  <strong className="text-slate-800">Thailand PDPA Representative:</strong>{' '}
                  For users in Thailand, please contact our PDPA representative at{' '}
                  <a href="mailto:pdpa-th@mumtaz.ai" className="text-purple-600 underline">pdpa-th@mumtaz.ai</a>{' '}
                  with subject &quot;PDPA Thailand Request&quot;.
                </p>
                <p className="text-sm text-slate-600">
                  <strong className="text-slate-800">Singapore PDPA Representative:</strong>{' '}
                  For users in Singapore, please contact our Data Protection Officer at{' '}
                  <a href="mailto:pdpa-sg@mumtaz.ai" className="text-purple-600 underline">pdpa-sg@mumtaz.ai</a>{' '}
                  with subject &quot;PDPA Singapore Request&quot;.
                </p>
                <p className="text-sm text-slate-600">
                  <strong className="text-slate-800">UAE PDPL Representative:</strong>{' '}
                  For users in the United Arab Emirates, please contact our UAE data protection representative at{' '}
                  <a href="mailto:pdpl-uae@mumtaz.ai" className="text-purple-600 underline">pdpl-uae@mumtaz.ai</a>{' '}
          ...
          <section id="securetrace" className="scroll-mt-24">
            ...
            <p className="text-slate-600 mb-6">
              ...
              as an opt-in add-on within the Mumtaz AI platform. This section describes exactly
              what data is collected, how it is used, and your rights regarding that data.
            </p>

            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold mb-2 text-slate-800">What SecureTrace Collects</h3>
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border-collapse border border-white/80 rounded-lg overflow-hidden">
                    <thead>
                      <tr className="bg-green-50 text-slate-800">
                        <th className="text-left p-3 border border-white/80 font-semibold">Data Type</th>
                        <th className="text-left p-3 border border-white/80 font-semibold">Purpose</th>
                        <th className="text-left p-3 border border-white/80 font-semibold">Frequency</th>
                      </tr>
                    </thead>
                    <tbody className="text-slate-600">
                      <tr><td className="p-3 border border-white/80 font-medium">GPS Coordinates (lat/lng)</td><td className="p-3 border border-white/80">Device location for recovery — <strong>collected only AFTER security team manually activates tracking</strong></td><td className="p-3 border border-white/80">Every 5 min (every 30s if marked lost) — <strong>never at registration</strong></td></tr>
                      <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Location Accuracy / Altitude</td><td className="p-3 border border-white/80">Precision tracking</td><td className="p-3 border border-white/80">With each GPS ping</td></tr>
                      <tr><td className="p-3 border border-white/80 font-medium">Battery Level</td><td className="p-3 border border-white/80">Device health monitoring</td><td className="p-3 border border-white/80">With each GPS ping</td></tr>
                      <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Network Type (WiFi / Mobile)</td><td className="p-3 border border-white/80">Connectivity monitoring</td><td className="p-3 border border-white/80">With each GPS ping</td></tr>
                      <tr><td className="p-3 border border-white/80 font-medium">Device Fingerprint (hashed)</td><td className="p-3 border border-white/80">One-device licensing</td><td className="p-3 border border-white/80">At registration only</td></tr>
                      <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">SIM Serial Hash</td><td className="p-3 border border-white/80">SIM swap detection / theft alert</td><td className="p-3 border border-white/80">On SIM state change</td></tr>
                      <tr><td className="p-3 border border-white/80 font-medium">Camera Image (on-demand)</td><td className="p-3 border border-white/80">Silent photo on remote command only</td><td className="p-3 border border-white/80">Only when owner issues command</td></tr>
                      <tr className="bg-transparent"><td className="p-3 border border-white/80 font-medium">Device Model / OS</td><td className="p-3 border border-white/80">Device identification</td><td className="p-3 border border-white/80">At registration</td></tr>
                      <tr><td className="p-3 border border-white/80 font-medium">IP Address</td><td className="p-3 border border-white/80">Security and abuse prevention</td><td className="p-3 border border-white/80">With each API request</td></tr>
                    </tbody>
                  </table>
                </div>
              </div>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-slate-800">How SecureTrace Data Is Used</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-slate-800">Consent &amp; Opt-Out</h3>
                <p className="text-slate-600 text-sm mb-3">
                  SecureTrace is <strong>entirely optional</strong>. You are prompted to register it when
                  first using the Mumtaz AI platform. Clicking &quot;No thanks&quot; permanently opts you out.
                  Clicking &quot;Register Device&quot; stores <em>only</em> a hashed device fingerprint — no tracking occurs.
                </p>
                <p className="text-slate-600 text-sm">
                  To revoke consent after registering, clear your browser&apos;s localStorage (key: <code className="bg-white/40 px-1 py-0.5 rounded text-xs">sct_opted</code>, <code className="bg-white/40 px-1 py-0.5 rounded text-xs">st_device_token</code>)
                  and contact us at{' '}
                  <a href="mailto:privacy@mumtaz.ai" className="text-blue-600 underline">privacy@mumtaz.ai</a>{' '}
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-slate-800">Manual Activation Process</h3>
                <p className="text-slate-600 text-sm mb-3">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-slate-800">Data Retention</h3>
                <ul className="list-disc list-inside text-slate-600 space-y-1 text-sm">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-slate-800">Location Unlock Payment</h3>
                <p className="text-slate-600 text-sm">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-slate-800">Native App (Android)</h3>
                <p className="text-slate-600 text-sm mb-3">
                  The SecureTrace Android application operates as a background service. It requests the
                  following Android permissions:
                </p>
                <ul className="list-disc list-inside text-slate-600 space-y-1 text-sm">
                  <li><code className="bg-white/40 px-1 rounded text-xs">ACCESS_FINE_LOCATION</code> + <code className="bg-white/40 px-1 rounded text-xs">ACCESS_BACKGROUND_LOCATION</code> — GPS tracking</li>
                  <li><code className="bg-white/40 px-1 rounded text-xs">CAMERA</code> — Remote camera capture (on-command only)</li>
                  <li><code className="bg-white/40 px-1 rounded text-xs">READ_PHONE_STATE</code> — SIM serial for swap detection</li>
                  <li><code className="bg-white/40 px-1 rounded text-xs">RECEIVE_BOOT_COMPLETED</code> — Restart tracking after device reboot</li>
                  <li><code className="bg-white/40 px-1 rounded text-xs">BIND_DEVICE_ADMIN</code> — Optional: prevents unauthorized uninstallation</li>
                </ul>
              </div>
            </div>
          </section>
