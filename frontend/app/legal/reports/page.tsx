...
export default function ReportsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!turnstileToken) {
      setErrors({ submit: 'Please complete the verification challenge' })
    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-14 md:py-20 overflow-hidden rounded-b-[2rem] themed-section-bg">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent mb-4">Report Inappropriate Activity</h1>
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white/40 backdrop-blur-lg rounded-2xl p-6 border border-white/60 shadow-lg hover:border-red-400 transition-all">
              <Shield className="w-8 h-8 text-red-500 mb-3" />
              <h3 className="text-lg font-bold text-slate-800 mb-2">Your Safety Matters</h3>
              <p className="text-slate-500">
                We take all reports seriously and investigate them thoroughly to protect our community.
              </p>
            </div>

            <div className="bg-white/40 backdrop-blur-lg rounded-2xl p-6 border border-white/60 shadow-lg hover:border-orange-400 transition-all">
              <FileText className="w-8 h-8 text-orange-500 mb-3" />
              <h3 className="text-lg font-bold text-slate-800 mb-2">Detailed Documentation</h3>
              <p className="text-slate-500">
                Provide as much detail as possible to help us understand and resolve the issue quickly.
              </p>
            </div>

            <div className="bg-white/40 backdrop-blur-lg rounded-2xl p-6 border border-white/60 shadow-lg hover:border-yellow-400 transition-all">
              <Mail className="w-8 h-8 text-yellow-500 mb-3" />
              <h3 className="text-lg font-bold text-slate-800 mb-2">Confidential Handling</h3>
              <p className="text-slate-500">
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="bg-white/40 backdrop-blur-lg rounded-2xl p-8 border border-white/60 shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    } rounded-lg text-slate-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 transition`}
                  />
                  {errors.name && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="reportType" className="block text-sm font-semibold text-slate-800 mb-2">
                    Report Type *
                  </label>
                  <select
                    id="reportType"
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 bg-transparent border border-white/60 rounded-lg text-slate-800 focus:outline-none focus:ring-2 focus:ring-red-500 transition"
                  >
                ...
                <div>
                  <label htmlFor="severity" className="block text-sm font-semibold text-slate-800 mb-2">
                    Severity Level *
                  </label>
                  <select
                    id="severity"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="agentName" className="block text-sm font-semibold text-slate-800 mb-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-transparent border border-white/60 rounded-lg text-slate-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 transition"
                  />
                </div>

                <div>
                  <label htmlFor="timestamp" className="block text-sm font-semibold text-slate-800 mb-2">
                    When Did This Occur?
                  </label>
                  <input
                    type="datetime-local"
              ...
              <div>
                <label htmlFor="description" className="block text-sm font-semibold text-slate-800 mb-2">
                  Detailed Description of the Issue * <span className="text-slate-400">(minimum 50 characters)</span>
                </label>
                <textarea
                  id="description"
                  name="description"
                  ...
                  rows={5}
                  className={`w-full px-4 py-3 bg-transparent border ${
                    errors.description ? 'border-red-500' : 'border-white/60'
                  } rounded-lg text-slate-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 transition resize-none`}
                />
                <div className="flex justify-between items-center mt-2">
                  <p className={`text-sm ${errors.description ? 'text-red-600' : 'text-slate-400'}`}>
              ...
              {/* Evidence */}
              <div>
                <label htmlFor="evidence" className="block text-sm font-semibold text-slate-800 mb-2">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-3 bg-transparent border border-white/60 rounded-lg text-slate-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 transition resize-none"
                />
              </div>

              {/* Previous Actions */}
              <div>
                <label htmlFor="actions" className="block text-sm font-semibold text-slate-800 mb-2">
              ...
              {/* Contact Preference */}
              <div>
                <label htmlFor="contactPreference" className="block text-sm font-semibold text-slate-800 mb-2">
              ...
              <div className="flex items-start gap-3">
                <input
                  ...
                  onChange={handleInputChange}
                  className="mt-1 w-4 h-4 red-600 cursor-pointer"
                />
                <label htmlFor="agreeToTerms" className="text-sm text-slate-600 cursor-pointer flex-1">
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="space-y-4">
            <details className="bg-white/40 backdrop-blur-lg rounded-2xl p-6 border border-white/60 open:border-red-400 cursor-pointer shadow-sm">
              <summary className="flex items-center gap-3 font-semibold text-slate-800 cursor-pointer">
      ...
      {/* Contact Section */}
      <section className="relative overflow-hidden rounded-2xl mx-4 mb-8 p-8 themed-section-bg">
        ...
        <div className="container mx-auto px-4 max-w-3xl text-center relative z-10">
          <h2 className="text-3xl font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent mb-4">Need Additional Help?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="px-8 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-semibold rounded-xl transition-all transform hover:scale-105"
            >
              Contact Us
            </a>
            <a
              href="/legal/privacy-policy"
              className="px-8 py-3 bg-white/60 hover:bg-white/80 text-slate-800 font-semibold rounded-xl transition-all transform hover:scale-105 border border-white/60"
            >
              Privacy Policy
            </a>
          </div>
