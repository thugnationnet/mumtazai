...
<head>
  ...
  <title>New Demo Request - Mumtaz AI</title>
  <style>
...
<body>
  <div class="container">
    <div class="header">
      ...
      <p>Someone wants to see Mumtaz AI in action</p>
    </div>
    <div class="content">
    ...
    <div class="footer">
      <p class="footer-text">
        This notification was sent from Mumtaz AI Demo Request Form<br>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Demo Request Received - Mumtaz AI</title>
  <style>
    body { margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); }
    .container { max-width: 600px; margin: 40px auto; background: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 20px 60px rgba(0,0,0,0.3); }
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p class="message">
        Thank you for your interest in Mumtaz AI! We're excited to show you how our AI agents can transform your workflow.
      </p>
...
export async function POST(request: NextRequest) {
  try {
    const { name, email, company, phone, interest, date, time, message, turnstileToken } = await request.json();
    ...
    if (transporter) {
      try {
        ...
        await transporter.sendMail({
          from: 'Mumtaz AI <noreply@mumtaz.ai>',
          to: ADMIN_EMAIL,
          replyTo: email,
        ...
        await transporter.sendMail({
          from: 'Mumtaz AI <noreply@mumtaz.ai>',
          to: email,
          subject: '🎉 Demo Request Received - Mumtaz AI',
