...
<head>
  ...
  <title>Reset Your Password - Mumtaz AI</title>
  <style>
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p class="message">
        We received a request to reset your password for your Mumtaz AI account.
    ...
    <div class="footer">
      <p class="footer-text">
        This email was sent by Mumtaz AI<br>
    ...
    if (transporter) {
      try {
        await transporter.sendMail({
          ...
          to: user.email,
          subject: '🔐 Reset Your Password - Mumtaz AI',
