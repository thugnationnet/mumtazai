...
/**
 * GET /api/auth/github/callback — Proxy GitHub OAuth callback to backend
...
export async function GET(request: NextRequest) {
  try {
    ...
    const backendUrl = `${BACKEND_URL}/api/auth/github/callback?code=${encodeURIComponent(code)}&state=${encodeURIComponent(state)}`;
