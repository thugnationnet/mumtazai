    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <section className="bg-gradient-to-r from-brand-600 to-accent-600 text-white py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-2xl md:text-3xl font-bold mb-1">Two-Factor Authentication</h1>
          <p className="text-sm opacity-90">Enter the 6-digit code from your authenticator app</p>
        </div>
      </section>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-neural-100 p-6">
            <div className="text-center mb-5">
              ...
              <h2 className="text-xl font-bold text-neural-800">Verify Your Identity</h2>
              <p className="text-xs text-neural-600 mt-0.5">Enter the code from your authenticator app</p>
            </div>
            ...
            <div className="mt-4 text-center">
              <p className="text-xs text-neural-500">
                Open your authenticator app (Google Authenticator, Authy, etc.) and enter the 6-digit code shown for One Last AI.
              </p>
            </div>
            ...
            <div className="mt-4 pt-4 border-t border-neural-100 text-center">
              <p className="text-xs text-neural-500">
                ...
                <Link href="/auth/recovery" className="text-brand-600 hover:text-brand-700 font-semibold">
                  Use a backup code
                </Link>
              </p>
            </div>
