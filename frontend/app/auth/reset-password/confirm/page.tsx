  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/auth/reset-password', {
        ...
        body: JSON.stringify({ token, email, password: newPassword, turnstileToken }),
      });
      ...
      <section className="relative py-10 overflow-hidden rounded-b-[2rem] themed-section-bg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="max-w-xl mx-auto bg-white/30 backdrop-blur-2xl border border-white/50 rounded-3xl p-6 md:p-8 shadow-[0_8px_40px_rgba(139,92,246,0.12),inset_0_1px_0_rgba(255,255,255,0.6)]">
            ...
            <h1 className="text-2xl md:text-3xl font-black bg-gradient-to-r from-slate-800 via-purple-800 to-indigo-700 bg-clip-text text-transparent mb-1">Create New Password</h1>
        ...
        <div className="w-full max-w-lg">
          ...
          <div className="relative glass-card p-6">
            <div className="text-center mb-4">
              ...
              <h2 className="text-xl font-bold text-slate-700">Set New Password</h2>
              <p className="text-xs text-slate-400 mt-0.5">Make sure it&apos;s at least 8 characters</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label htmlFor="newPassword" className="block text-sm font-medium text-slate-500 mb-1">
                    New Password
                  </label>
