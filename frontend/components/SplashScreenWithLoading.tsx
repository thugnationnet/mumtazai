...
export default function SplashScreenWithLoading() {
        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              className="w-24 h-24 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-2xl flex items-center justify-center shadow-2xl"
            >
              <motion.div
                animate={{ rotate: 360 }}
                transition={{ duration: 3, repeat: Infinity, ease: 'linear' }}
                className="text-slate-900 font-bold text-5xl"
              >
                AI
              </motion.div>
            </motion.div>
