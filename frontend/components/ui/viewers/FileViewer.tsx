        ...
        return (
          <div className="p-6 bg-gray-100 rounded-lg">
            <div className="flex items-center space-x-4 mb-4">
              <div className={`p-3 rounded-full bg-pink-100 ${fileInfo.color}`}>
              ...
              {onClose && (
                <button onClick={onClose} className="ml-auto p-2 hover:bg-gray-200 rounded">
      ...
      default:
        return (
          <div className="p-6 bg-gray-100 rounded-lg text-center">
            <div className={`inline-block p-4 rounded-full bg-gray-200 mb-4 ${fileInfo.color}`}>
              <fileInfo.icon className="w-12 h-12" />
            </div>
            <h3 className="font-medium text-gray-900 mb-2">{filename}</h3>
  ...
  if (error) {
    return (
      <div className="p-6 bg-red-50 rounded-lg text-center">
        ...
        <h3 className="font-medium text-red-700 mb-2">Failed to load file</h3>
        <p className="text-sm text-red-600">{error}</p>
        {onClose && (
          <button
            onClick={onClose}
            className="mt-4 px-4 py-2 bg-red-600 text-slate-900 rounded-lg hover:bg-red-700 transition-colors"
          >
            Close
          </button>
        )}
