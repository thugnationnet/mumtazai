...
const ChatBox: React.FC<ChatBoxProps> = ({ 
  ...
  // Like/Unlike message — persisted to DB via parent
  const handleLike = (messageId: string) => {
    onFeedback?.(messageId, 'up');
  };

  // Dislike message — persisted to DB via parent
                  ...
                  {msg.sender === 'AGENT' ? (
                    <>
                      ...
                      <button
                        ...
                        className={`p-1.5 rounded transition-all ${messageFeedback[msg.id] === 'up' ? 'text-emerald-400 bg-emerald-500/10' : 'text-gray-600 hover:text-emerald-400 hover:bg-emerald-500/10'}`}
                      ...
                      <button
                        ...
                        className={`p-1.5 rounded transition-all ${messageFeedback[msg.id] === 'down' ? 'text-red-400 bg-red-500/10' : 'text-gray-600 hover:text-red-400 hover:bg-red-500/10'}`}
