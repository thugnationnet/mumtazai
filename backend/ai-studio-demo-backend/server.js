/**
 * AI STUDIO DEMO - STANDALONE BACKEND SERVER
 * Port 3009 · PostgreSQL/Prisma · Separate database
 */
...
async function initializeServer() {
  try {
    console.log('🔧 Initializing Mumtaz AI Server...');
    ...
    server.listen(PORT, host, () => {
      console.log(`🚀 AI Studio Demo Backend running on ${host}:${PORT}`);
