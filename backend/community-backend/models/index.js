...
class CommunitySuggestionAdapter {
  ...
  _getData() {
    const { _isNew, id, createdAt, updatedAt, ...rest } = this;
    const data = {
      userId: rest.userId || null,
      title: rest.title,
    ...
    if (rest.suggestionId !== undefined) data.suggestionId = rest.suggestionId;
    if (rest.userEmail !== undefined) data.userEmail = rest.userEmail;
    if (rest.userName !== undefined) data.userName = rest.userName;
    if (rest.isAnonymous !== undefined) data.isAnonymous = rest.isAnonymous;
    if (rest.relatedTo !== undefined) data.relatedTo = rest.relatedTo;
    if (rest.userPriority !== undefined) data.userPriority = rest.userPriority;
    if (rest.tags !== undefined) data.tags = rest.tags;
    if (rest.votesUp !== undefined) data.votesUp = rest.votesUp;
    if (rest.votesDown !== undefined) data.votesDown = rest.votesDown;
    if (rest.voters !== undefined) data.voters = rest.voters;
