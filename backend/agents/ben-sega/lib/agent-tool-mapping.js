...
const AGENT_EXTRA_TOOLS = {
  'ben-sega': [
    // Creative / game dev
    'execute_code', 'generate_code', 'debug_code',
    'image_create', 'image_transform', 'image_compose', 'image_filter',
    'generate_video', 'video_transform',
    'dev_filesystem', 'dev_search', 'web_scaffold',
  ],
};
