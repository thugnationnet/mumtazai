// ═══════════════════════════════════════════════════════════════════════════════
// AGENT TOOL MAPPING — knight-logic
...
const AGENT_EXTRA_TOOLS = {
  'knight-logic': [
    // Strategic thinker
    'execute_code', 'generate_code', 'data_visualize', 'trend_analyze', 'forecast_model',
    'workflow_create', 'workflow_execute', 'workflow_visualize', 'workflow_optimize',
    'kg_create', 'kg_query', 'kg_visualize', 'kg_reason',
    'growth_analyze', 'pricing_simulate', 'ab_test_run', 'cohort_analyze', 'funnel_optimize',
  ],
};
