// ═══════════════════════════════════════════════════════════════════════════════
// AGENT TOOL MAPPING — travel-buddy
...
const AGENT_EXTRA_TOOLS = {
  'travel-buddy': [
    // Travel — geo, planning, images
    'image_create', 'geo_geocode', 'geo_route', 'geo_distance', 'geo_search', 'geo_timezone', 'geo_elevation',
    'calendar_manage', 'budget_plan', 'currency_convert',
  ],
};
