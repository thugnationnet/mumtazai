/**
 * PLAN / SUBSCRIPTION MIDDLEWARE — Canvas Studio (GenCraft)
 * Server-side enforcement of canvas-studio subscription requirement.
 *
 ...
 * Returns 403 if user has no active GenCraft subscription.
